...
public class ahm extends DataFix {
	...
	public ahm(Schema schema, boolean boolean2) {
	...
	public TypeRewriteRule makeRule() {
		Type<Either<Integer, Pair<String, String>>> type2 = DSL.or(DSL.intType(), DSL.named(ajb.r.typeName(), aka.a()));
		Type<Pair<String, String>> type3 = DSL.named(ajb.r.typeName(), aka.a());
		OpticFinder<Either<Integer, Pair<String, String>>> opticFinder4 = DSL.fieldFinder("id", type2);
		return this.fixTypeEverywhereTyped(
			"ItemIdFix",
			this.getInputSchema().getType(ajb.l),
			this.getOutputSchema().getType(ajb.l),
			typed -> typed.update(opticFinder4, type3, either -> either.map(integer -> Pair.of(ajb.r.typeName(), a(integer.intValue())), pair -> pair))
		);
	}
}
