...
public final class btj extends bre {
	protected btj() {
		super(
			new bre.a()
				.a(cvw.S, cvw.D)
				...
				.a(null)
				.a(ImmutableList.of(new bre.d(0.0F, 0.0F, 0.0F, 0.0F, 1.0F)))
		);
		this.a(brf.t);
		this.a(brf.a);
		brf.b(this);
		...
		this.a(apa.CREATURE, new bre.g(aoq.H, 5, 2, 6));
		this.a(apa.CREATURE, new bre.g(aoq.o, 1, 1, 3));
