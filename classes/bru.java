	...
	public bru() {
		super(
			new bre.a()
				...
				.c(0.5F)
				.d(0.5F)
				.a(new bri.a().b(4566514).c(267827).a(12638463).a(bqw.b).a())
				.a(null)
		);
		this.a(brf.n);
		this.a(brf.l);
		...
		brf.an(this);
		brf.ar(this);
		this.a(apa.WATER_CREATURE, new bre.g(aoq.aC, 8, 1, 4));
		this.a(apa.WATER_AMBIENT, new bre.g(aoq.k, 8, 3, 6));
		this.a(apa.WATER_AMBIENT, new bre.g(aoq.am, 5, 1, 3));
		this.a(apa.WATER_AMBIENT, new bre.g(aoq.aL, 25, 8, 8));
		this.a(apa.WATER_CREATURE, new bre.g(aoq.n, 2, 1, 2));
