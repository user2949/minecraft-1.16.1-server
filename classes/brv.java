...
public final class brv extends bre {
	public brv() {
		super(
			new bre.a()
				.a(cvw.S, cvw.D)
		...
		brf.ac(this);
		brf.ao(this);
		this.a(cin.b.VEGETAL_DECORATION, ckt.D.b(new col(48, 0.8)).a(csc.v.a(cnn.f)));
		brf.ak(this);
		brf.aj(this);
		brf.ar(this);
		this.a(apa.WATER_CREATURE, new bre.g(aoq.aC, 1, 1, 4));
		this.a(apa.WATER_AMBIENT, new bre.g(aoq.k, 10, 3, 6));
		this.a(apa.WATER_CREATURE, new bre.g(aoq.n, 1, 1, 2));
