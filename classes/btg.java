...
public final class btg extends bre {
	protected btg() {
		super(
			new bre.a()
				.a(cvw.ac, cvw.M)
				...
				.c(2.0F)
				.d(0.0F)
				.a(new bri.a().b(4159204).c(329011).a(3344392).a(acl.i).a(new bqw(acl.j, 6000, 8, 2.0)).a(new bqv(acl.h, 0.0111)).a(acj.a(acl.ip)).a())
				.a(null)
				.a(ImmutableList.of(new bre.d(0.0F, 0.0F, 0.0F, 0.0F, 0.0F)))
		);
		this.a(brf.E);
		this.a(brf.o);
		this.a(brf.s);
		...
		brf.as(this);
		this.a(apa.MONSTER, new bre.g(aoq.D, 50, 4, 4));
		this.a(apa.MONSTER, new bre.g(aoq.ba, 100, 4, 4));
		this.a(apa.MONSTER, new bre.g(aoq.S, 2, 4, 4));
		this.a(apa.MONSTER, new bre.g(aoq.u, 1, 4, 4));
		this.a(apa.MONSTER, new bre.g(aoq.ai, 15, 4, 4));
