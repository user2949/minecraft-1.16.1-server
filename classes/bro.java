...
public class bro extends bre {
	public bro() {
		...
		brf.ac(this);
		brf.ao(this);
		this.a(cin.b.VEGETAL_DECORATION, ckt.D.b(new col(32, 0.3)).a(csc.v.a(cnn.f)));
		brf.ak(this);
		brf.aj(this);
		brf.ar(this);
		this.a(apa.WATER_CREATURE, new bre.g(aoq.aC, 3, 1, 4));
		this.a(apa.WATER_AMBIENT, new bre.g(aoq.k, 15, 3, 6));
