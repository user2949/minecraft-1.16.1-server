...
public final class brq extends bre {
	public brq() {
		super(
			new bre.a()
				.a(cvw.S, cvw.D)
		...
		brf.h(this);
		this.a(
			cin.b.VEGETAL_DECORATION,
			ckt.X
				.b(
					new cof(
						ImmutableList.of(ckt.n.b(brf.aX).a(0.025F), ckt.m.b(brf.aW).a(0.05F), ckt.c.b(brf.Z).a(0.6666667F), ckt.c.b(brf.O).a(0.2F), ckt.c.b(brf.U).a(0.1F)),
						ckt.c.b(brf.F)
					)
				)
				.a(csc.G.a(cnn.f))
