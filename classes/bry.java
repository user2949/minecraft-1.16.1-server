...
public final class bry extends bre {
	public bry() {
		super(
			new bre.a()
				.a(cvw.S, cvw.H)
		...
		this.a(apa.MONSTER, new bre.g(aoq.aX, 19, 4, 4));
		this.a(apa.MONSTER, new bre.g(aoq.aZ, 1, 1, 1));
		this.a(apa.MONSTER, new bre.g(aoq.I, 80, 4, 4));
	}
}
