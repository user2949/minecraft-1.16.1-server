	...
	public brb() {
		super(
			new bre.a()
				...
				.a(null)
				.a(ImmutableList.of(new bre.d(0.5F, 0.5F, 0.25F, 0.2F, 1.0F)))
		);
		this.a(brf.e);
		brf.b(this);
		this.a(brf.A);
		...
		this.a(apa.CREATURE, new bre.g(aoq.af, 10, 1, 1));
		this.a(apa.CREATURE, new bre.g(aoq.ae, 80, 1, 2));
		this.a(apa.CREATURE, new bre.g(aoq.j, 10, 4, 4));
		...
		this.a(apa.MONSTER, new bre.g(aoq.ac, 2, 1, 1));
	}
}
