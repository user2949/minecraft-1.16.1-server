...
public class Byte2DoubleOpenCustomHashMap extends AbstractByte2DoubleMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		byte[] key = this.key;
		double[] value = this.value;
		Byte2DoubleOpenCustomHashMap.MapIterator i = new Byte2DoubleOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Byte2DoubleOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.bytes.Byte2DoubleMap.Entry> {
	...
	private class FastEntryIterator extends Byte2DoubleOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.bytes.Byte2DoubleMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.bytes.Byte2DoubleMap.Entry, java.util.Map.Entry<Byte, Double> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Byte2DoubleOpenCustomHashMap.this.strategy.equals(Byte2DoubleOpenCustomHashMap.this.key[this.index], (Byte)e.getKey())
					&& Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits((Double)e.getValue());
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.bytes.Byte2DoubleMap.Entry> implements FastEntrySet {
				...
				if (e.getKey() == null || !(e.getKey() instanceof Byte)) {
					...
					if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
						...
						if ((curr = key[pos = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2DoubleOpenCustomHashMap.this.mask]) == 0) {
							return false;
						} else if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
				...
				if (e.getKey() != null && e.getKey() instanceof Byte) {
					if (e.getValue() != null && e.getValue() instanceof Double) {
						...
						if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
							...
							if ((curr = key[pos = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2DoubleOpenCustomHashMap.this.mask]) == 0) {
								return false;
							} else if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.bytes.Byte2DoubleMap.Entry> consumer) {
			if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Byte2DoubleOpenCustomHashMap.this.key[Byte2DoubleOpenCustomHashMap.this.n], Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n]
					)
				);
			}
