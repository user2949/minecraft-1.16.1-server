...
import it.unimi.dsi.fastutil.bytes.Byte2ReferenceFunctions.EmptyFunction;
import it.unimi.dsi.fastutil.bytes.Byte2ReferenceFunctions.SynchronizedFunction;
import it.unimi.dsi.fastutil.bytes.Byte2ReferenceFunctions.UnmodifiableFunction;
...
public final class Byte2ReferenceMaps {
	...
	public static <V> ObjectIterator<Entry<V>> fastIterator(Byte2ReferenceMap<V> map) {
		ObjectSet<Entry<V>> entries = map.byte2ReferenceEntrySet();
		return entries instanceof FastEntrySet ? ((FastEntrySet)entries).fastIterator() : entries.iterator();
	}

	public static <V> void fastForEach(Byte2ReferenceMap<V> map, Consumer<? super Entry<V>> consumer) {
		ObjectSet<Entry<V>> entries = map.byte2ReferenceEntrySet();
	...
	public static <V> ObjectIterable<Entry<V>> fastIterable(Byte2ReferenceMap<V> map) {
		final ObjectSet<Entry<V>> entries = map.byte2ReferenceEntrySet();
	...
	public static class EmptyMap<V> extends EmptyFunction<V> implements Byte2ReferenceMap<V>, Serializable, Cloneable {
	...
	public static class SynchronizedMap<V> extends SynchronizedFunction<V> implements Byte2ReferenceMap<V>, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableMap<V> extends UnmodifiableFunction<V> implements Byte2ReferenceMap<V>, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Byte2ReferenceMap<V> map;
		protected transient ObjectSet<Entry<V>> entries;
		protected transient ByteSet keys;
