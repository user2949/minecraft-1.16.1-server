...
public class Byte2CharOpenHashMap extends AbstractByte2CharMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		byte[] key = this.key;
		char[] value = this.value;
		Byte2CharOpenHashMap.MapIterator i = new Byte2CharOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Byte2CharOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.bytes.Byte2CharMap.Entry> {
	...
	private class FastEntryIterator extends Byte2CharOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.bytes.Byte2CharMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.bytes.Byte2CharMap.Entry, java.util.Map.Entry<Byte, Character> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Byte2CharOpenHashMap.this.key[this.index] == (Byte)e.getKey() && Byte2CharOpenHashMap.this.value[this.index] == (Character)e.getValue();
			}
		}
