...
public class Byte2FloatOpenHashMap extends AbstractByte2FloatMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		byte[] key = this.key;
		float[] value = this.value;
		Byte2FloatOpenHashMap.MapIterator i = new Byte2FloatOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Byte2FloatOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.bytes.Byte2FloatMap.Entry> {
	...
	private class FastEntryIterator extends Byte2FloatOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.bytes.Byte2FloatMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.bytes.Byte2FloatMap.Entry, java.util.Map.Entry<Byte, Float> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Byte2FloatOpenHashMap.this.key[this.index] == (Byte)e.getKey()
					&& Float.floatToIntBits(Byte2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits((Float)e.getValue());
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.bytes.Byte2FloatMap.Entry> implements FastEntrySet {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.bytes.Byte2FloatMap.Entry> consumer) {
			if (Byte2FloatOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Byte2FloatOpenHashMap.this.key[Byte2FloatOpenHashMap.this.n], Byte2FloatOpenHashMap.this.value[Byte2FloatOpenHashMap.this.n])
				);
			}
