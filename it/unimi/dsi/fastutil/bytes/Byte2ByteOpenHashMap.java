...
public class Byte2ByteOpenHashMap extends AbstractByte2ByteMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		byte[] key = this.key;
		byte[] value = this.value;
		Byte2ByteOpenHashMap.MapIterator i = new Byte2ByteOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Byte2ByteOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.bytes.Byte2ByteMap.Entry> {
	...
	private class FastEntryIterator extends Byte2ByteOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.bytes.Byte2ByteMap.Entry> {
