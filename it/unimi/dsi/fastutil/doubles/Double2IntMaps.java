...
import it.unimi.dsi.fastutil.doubles.Double2IntFunctions.EmptyFunction;
import it.unimi.dsi.fastutil.doubles.Double2IntFunctions.SynchronizedFunction;
import it.unimi.dsi.fastutil.doubles.Double2IntFunctions.UnmodifiableFunction;
...
public final class Double2IntMaps {
	...
	public static ObjectIterator<Entry> fastIterator(Double2IntMap map) {
		ObjectSet<Entry> entries = map.double2IntEntrySet();
		return entries instanceof FastEntrySet ? ((FastEntrySet)entries).fastIterator() : entries.iterator();
	}

	public static void fastForEach(Double2IntMap map, Consumer<? super Entry> consumer) {
		ObjectSet<Entry> entries = map.double2IntEntrySet();
	...
	public static ObjectIterable<Entry> fastIterable(Double2IntMap map) {
		final ObjectSet<Entry> entries = map.double2IntEntrySet();
	...
	public static class EmptyMap extends EmptyFunction implements Double2IntMap, Serializable, Cloneable {
	...
	public static class Singleton extends Double2IntFunctions.Singleton implements Double2IntMap, Serializable, Cloneable {
		...
		@Deprecated
		@Override
		public ObjectSet<java.util.Map.Entry<Double, Integer>> entrySet() {
	...
	public static class SynchronizedMap extends SynchronizedFunction implements Double2IntMap, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableMap extends UnmodifiableFunction implements Double2IntMap, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Double2IntMap map;
		protected transient ObjectSet<Entry> entries;
		protected transient DoubleSet keys;
