...
import it.unimi.dsi.fastutil.doubles.Double2ObjectFunctions.EmptyFunction;
import it.unimi.dsi.fastutil.doubles.Double2ObjectFunctions.SynchronizedFunction;
import it.unimi.dsi.fastutil.doubles.Double2ObjectFunctions.UnmodifiableFunction;
...
public final class Double2ObjectMaps {
	...
	public static <V> ObjectIterator<Entry<V>> fastIterator(Double2ObjectMap<V> map) {
		ObjectSet<Entry<V>> entries = map.double2ObjectEntrySet();
		return entries instanceof FastEntrySet ? ((FastEntrySet)entries).fastIterator() : entries.iterator();
	}

	public static <V> void fastForEach(Double2ObjectMap<V> map, Consumer<? super Entry<V>> consumer) {
		ObjectSet<Entry<V>> entries = map.double2ObjectEntrySet();
	...
	public static <V> ObjectIterable<Entry<V>> fastIterable(Double2ObjectMap<V> map) {
		final ObjectSet<Entry<V>> entries = map.double2ObjectEntrySet();
	...
	public static class EmptyMap<V> extends EmptyFunction<V> implements Double2ObjectMap<V>, Serializable, Cloneable {
	...
	public static class SynchronizedMap<V> extends SynchronizedFunction<V> implements Double2ObjectMap<V>, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableMap<V> extends UnmodifiableFunction<V> implements Double2ObjectMap<V>, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Double2ObjectMap<V> map;
		protected transient ObjectSet<Entry<V>> entries;
		protected transient DoubleSet keys;
