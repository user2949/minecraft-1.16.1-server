...
public class Double2CharRBTreeMap extends AbstractDouble2CharSortedMap implements Serializable, Cloneable {
	...
	protected transient ObjectSortedSet<it.unimi.dsi.fastutil.doubles.Double2CharMap.Entry> entries;
				...
				while (true) {
					...
					if (!this.dirPath[i - 1]) {
						...
						if (this.nodePath[i - 1].succ() || y.black()) {
							...
							Double2CharRBTreeMap.Entry xx = this.nodePath[i - 1];
							xx.black(false);
							y.black(true);
							xx.left = y.right;
							y.right = xx;
						...
						if (this.nodePath[i - 1].pred() || y.black()) {
							...
							Double2CharRBTreeMap.Entry xxx = this.nodePath[i - 1];
							xxx.black(false);
							y.black(true);
							xxx.right = y.left;
							y.left = xxx;
			...
			if (p.black()) {
				for (; i > 0; i--) {
					...
					if (!this.dirPath[i - 1]) {
						...
						Double2CharRBTreeMap.Entry wx = this.nodePath[i - 1].left;
						if (!wx.black()) {
							wx.black(true);
							this.nodePath[i - 1].black(false);
						...
						if (!wx.pred() && !wx.left.black() || !wx.succ() && !wx.right.black()) {
							if (wx.pred() || wx.left.black()) {
								Double2CharRBTreeMap.Entry y = wx.right;
								y.black(true);
								wx.black(false);
								wx.right = y.left;
								y.left = wx;
	...
	@Override
	public ObjectSortedSet<it.unimi.dsi.fastutil.doubles.Double2CharMap.Entry> double2CharEntrySet() {
		if (this.entries == null) {
			this.entries = new AbstractObjectSortedSet<it.unimi.dsi.fastutil.doubles.Double2CharMap.Entry>() {
				final Comparator<? super it.unimi.dsi.fastutil.doubles.Double2CharMap.Entry> comparator = (x, y) -> Double2CharRBTreeMap.this.actualComparator
				...
				public ObjectBidirectionalIterator<it.unimi.dsi.fastutil.doubles.Double2CharMap.Entry> iterator(it.unimi.dsi.fastutil.doubles.Double2CharMap.Entry from) {
				...
				public ObjectSortedSet<it.unimi.dsi.fastutil.doubles.Double2CharMap.Entry> subSet(
					it.unimi.dsi.fastutil.doubles.Double2CharMap.Entry from, it.unimi.dsi.fastutil.doubles.Double2CharMap.Entry to
				) {
					return Double2CharRBTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2CharEntrySet();
				}

				public ObjectSortedSet<it.unimi.dsi.fastutil.doubles.Double2CharMap.Entry> headSet(it.unimi.dsi.fastutil.doubles.Double2CharMap.Entry to) {
					return Double2CharRBTreeMap.this.headMap(to.getDoubleKey()).double2CharEntrySet();
				}

				public ObjectSortedSet<it.unimi.dsi.fastutil.doubles.Double2CharMap.Entry> tailSet(it.unimi.dsi.fastutil.doubles.Double2CharMap.Entry from) {
	...
	private static final class Entry extends BasicEntry implements Cloneable {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Double.doubleToLongBits(this.key) == Double.doubleToLongBits((Double)e.getKey()) && this.value == (Character)e.getValue();
			}
		}
	...
	private class EntryIterator extends Double2CharRBTreeMap.TreeIterator implements ObjectListIterator<it.unimi.dsi.fastutil.doubles.Double2CharMap.Entry> {
		EntryIterator() {
		}
	...
	private class KeySet extends it.unimi.dsi.fastutil.doubles.AbstractDouble2CharSortedMap.KeySet {
		private KeySet() {
			super(Double2CharRBTreeMap.this);
		}
	...
	private final class Submap extends AbstractDouble2CharSortedMap implements Serializable {
		...
		public char get(double k) {
			Double2CharRBTreeMap.Entry e;
			return this.in(k) && (e = Double2CharRBTreeMap.this.findKey(k)) != null ? e.value : this.defRetValue;
		}
