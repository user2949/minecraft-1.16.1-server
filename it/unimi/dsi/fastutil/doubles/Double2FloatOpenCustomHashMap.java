...
public class Double2FloatOpenCustomHashMap extends AbstractDouble2FloatMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		double[] key = this.key;
		float[] value = this.value;
		Double2FloatOpenCustomHashMap.MapIterator i = new Double2FloatOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Double2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.doubles.Double2FloatMap.Entry> {
	...
	private class FastEntryIterator
		...
		implements ObjectIterator<it.unimi.dsi.fastutil.doubles.Double2FloatMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.doubles.Double2FloatMap.Entry, java.util.Map.Entry<Double, Float> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Double2FloatOpenCustomHashMap.this.strategy.equals(Double2FloatOpenCustomHashMap.this.key[this.index], (Double)e.getKey())
					&& Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((Float)e.getValue());
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.doubles.Double2FloatMap.Entry> implements FastEntrySet {
				...
				if (e.getKey() == null || !(e.getKey() instanceof Double)) {
					...
					if (Double2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
						...
						if (Double.doubleToLongBits(
							...
							== 0L) {
							return false;
						} else if (Double2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
					...
					if (e.getValue() != null && e.getValue() instanceof Float) {
						...
						if (Double2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
							...
							if (Double.doubleToLongBits(
								...
								== 0L) {
								return false;
							} else if (Double2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.doubles.Double2FloatMap.Entry> consumer) {
			if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Double2FloatOpenCustomHashMap.this.key[Double2FloatOpenCustomHashMap.this.n],
						Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n]
					)
				);
			}
