...
public class Double2ReferenceOpenHashMap<V> extends AbstractDouble2ReferenceMap<V> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		double[] key = this.key;
		V[] value = this.value;
		Double2ReferenceOpenHashMap<V>.MapIterator i = new Double2ReferenceOpenHashMap.MapIterator();
	...
	final class MapEntry implements it.unimi.dsi.fastutil.doubles.Double2ReferenceMap.Entry<V>, java.util.Map.Entry<Double, V> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Double.doubleToLongBits(Double2ReferenceOpenHashMap.this.key[this.index]) == Double.doubleToLongBits((Double)e.getKey())
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.doubles.Double2ReferenceMap.Entry<V>> implements FastEntrySet<V> {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.doubles.Double2ReferenceMap.Entry<V>> consumer) {
			if (Double2ReferenceOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Double2ReferenceOpenHashMap.this.key[Double2ReferenceOpenHashMap.this.n], Double2ReferenceOpenHashMap.this.value[Double2ReferenceOpenHashMap.this.n]
					)
				);
			}
