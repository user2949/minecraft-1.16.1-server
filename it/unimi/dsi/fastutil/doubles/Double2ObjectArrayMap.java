...
public class Double2ObjectArrayMap<V> extends AbstractDouble2ObjectMap<V> implements Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.doubles.Double2ObjectMap.Entry<V>> implements FastEntrySet<V> {
		private EntrySet() {
		}

		@Override
		public ObjectIterator<it.unimi.dsi.fastutil.doubles.Double2ObjectMap.Entry<V>> iterator() {
			return new ObjectIterator<it.unimi.dsi.fastutil.doubles.Double2ObjectMap.Entry<V>>() {
				int curr = -1;
				int next = 0;
				...
				public it.unimi.dsi.fastutil.doubles.Double2ObjectMap.Entry<V> next() {
					if (!this.hasNext()) {
						...
						return new BasicEntry<>(Double2ObjectArrayMap.this.key[this.curr = this.next], (V)Double2ObjectArrayMap.this.value[this.next++]);
					}
				}
