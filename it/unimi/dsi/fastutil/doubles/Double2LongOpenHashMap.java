...
public class Double2LongOpenHashMap extends AbstractDouble2LongMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		double[] key = this.key;
		long[] value = this.value;
		Double2LongOpenHashMap.MapIterator i = new Double2LongOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Double2LongOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.doubles.Double2LongMap.Entry> {
	...
	private class FastEntryIterator extends Double2LongOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.doubles.Double2LongMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.doubles.Double2LongMap.Entry, java.util.Map.Entry<Double, Long> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Double.doubleToLongBits(Double2LongOpenHashMap.this.key[this.index]) == Double.doubleToLongBits((Double)e.getKey())
					&& Double2LongOpenHashMap.this.value[this.index] == (Long)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.doubles.Double2LongMap.Entry> implements FastEntrySet {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.doubles.Double2LongMap.Entry> consumer) {
			if (Double2LongOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Double2LongOpenHashMap.this.key[Double2LongOpenHashMap.this.n], Double2LongOpenHashMap.this.value[Double2LongOpenHashMap.this.n])
				);
			}
	...
	private class MapIterator {
		...
		private void shiftKeys(int pos) {
			...
			while (true) {
				...
				double curr;
				for (pos = pos + 1 & Double2LongOpenHashMap.this.mask; Double.doubleToLongBits(curr = key[pos]) != 0L; pos = pos + 1 & Double2LongOpenHashMap.this.mask) {
