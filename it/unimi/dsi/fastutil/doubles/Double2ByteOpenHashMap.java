...
public class Double2ByteOpenHashMap extends AbstractDouble2ByteMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		double[] key = this.key;
		byte[] value = this.value;
		Double2ByteOpenHashMap.MapIterator i = new Double2ByteOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Double2ByteOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.doubles.Double2ByteMap.Entry> {
	...
	private class FastEntryIterator extends Double2ByteOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.doubles.Double2ByteMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.doubles.Double2ByteMap.Entry, java.util.Map.Entry<Double, Byte> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[this.index]) == Double.doubleToLongBits((Double)e.getKey())
					&& Double2ByteOpenHashMap.this.value[this.index] == (Byte)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.doubles.Double2ByteMap.Entry> implements FastEntrySet {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.doubles.Double2ByteMap.Entry> consumer) {
			if (Double2ByteOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Double2ByteOpenHashMap.this.key[Double2ByteOpenHashMap.this.n], Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.n])
				);
			}
	...
	private class MapIterator {
		...
		private void shiftKeys(int pos) {
			...
			while (true) {
				...
				double curr;
				for (pos = pos + 1 & Double2ByteOpenHashMap.this.mask; Double.doubleToLongBits(curr = key[pos]) != 0L; pos = pos + 1 & Double2ByteOpenHashMap.this.mask) {
