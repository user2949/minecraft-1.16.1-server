...
public final class BooleanArrays {
	...
	public static final Strategy<boolean[]> HASH_STRATEGY = new BooleanArrays.ArrayHashStrategy();
	...
	public static void mergeSort(boolean[] a, int from, int to) {
		mergeSort(a, from, to, (boolean[])a.clone());
	}
	...
	public static void mergeSort(boolean[] a, int from, int to, BooleanComparator comp) {
		mergeSort(a, from, to, comp, (boolean[])a.clone());
	}
	...
	private static final class ArrayHashStrategy implements Strategy<boolean[]>, Serializable {
				...
				while (true) {
					...
					while (b > c || (comparison = Boolean.compare(x[b], v)) > 0) {
						...
						if (b > c) {
							...
							comparison = d - c;
							if (s > 1 && comparison > 1) {
								invokeAll(new BooleanArrays.ForkJoinQuickSort(x, this.from, this.from + s), new BooleanArrays.ForkJoinQuickSort(x, this.to - comparison, this.to));
							} else if (s > 1) {
								invokeAll(new ForkJoinTask[]{new BooleanArrays.ForkJoinQuickSort(x, this.from, this.from + s)});
							} else {
								invokeAll(new ForkJoinTask[]{new BooleanArrays.ForkJoinQuickSort(x, this.to - comparison, this.to)});
							}
				...
				while (true) {
					...
					while (b > c || (comparison = (t = Boolean.compare(x[b], v)) == 0 ? Boolean.compare(y[b], w) : t) > 0) {
						...
						if (b > c) {
							...
							if (s > 1 && comparison > 1) {
								invokeAll(
									new BooleanArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s), new BooleanArrays.ForkJoinQuickSort2(x, y, this.to - comparison, this.to)
								);
							} else if (s > 1) {
								invokeAll(new ForkJoinTask[]{new BooleanArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s)});
							} else {
								invokeAll(new ForkJoinTask[]{new BooleanArrays.ForkJoinQuickSort2(x, y, this.to - comparison, this.to)});
							}
					...
					while (b > c || (comparison = this.comp.compare(x[b], v)) > 0) {
						...
						if (b > c) {
							...
							if (s > 1 && comparison > 1) {
								...
								invokeAll(new ForkJoinTask[]{new BooleanArrays.ForkJoinQuickSortComp(x, this.to - comparison, this.to, this.comp)});
							}
					...
					while (b > c || (comparison = Boolean.compare(x[this.perm[b]], v)) > 0) {
						...
						if (b > c) {
							...
							if (s > 1 && comparison > 1) {
								...
								invokeAll(new ForkJoinTask[]{new BooleanArrays.ForkJoinQuickSortIndirect(this.perm, x, this.to - comparison, this.to)});
							}
