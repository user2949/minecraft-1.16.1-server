...
public class Int2ObjectOpenCustomHashMap<V> extends AbstractInt2ObjectMap<V> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		int[] key = this.key;
		V[] value = this.value;
		Int2ObjectOpenCustomHashMap<V>.MapIterator i = new Int2ObjectOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Int2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.ints.Int2ObjectMap.Entry<V>> {
	...
	private class FastEntryIterator
		extends Int2ObjectOpenCustomHashMap<V>.MapIterator
	...
	final class MapEntry implements it.unimi.dsi.fastutil.ints.Int2ObjectMap.Entry<V>, java.util.Map.Entry<Integer, V> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Int2ObjectOpenCustomHashMap.this.strategy.equals(Int2ObjectOpenCustomHashMap.this.key[this.index], (Integer)e.getKey())
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.ints.Int2ObjectMap.Entry<V>> implements FastEntrySet<V> {
				...
				if (e.getKey() != null && e.getKey() instanceof Integer) {
					...
					if (Int2ObjectOpenCustomHashMap.this.strategy.equals(k, 0)) {
						...
						if ((curr = key[pos = HashCommon.mix(Int2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ObjectOpenCustomHashMap.this.mask]) == 0) {
							return false;
						} else if (Int2ObjectOpenCustomHashMap.this.strategy.equals(k, curr)) {
			...
			if (!(o instanceof java.util.Map.Entry)) {
				...
				if (e.getKey() != null && e.getKey() instanceof Integer) {
					...
					if (Int2ObjectOpenCustomHashMap.this.strategy.equals(k, 0)) {
						...
						if ((curr = key[pos = HashCommon.mix(Int2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ObjectOpenCustomHashMap.this.mask]) == 0) {
							return false;
						} else if (Int2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.ints.Int2ObjectMap.Entry<V>> consumer) {
			if (Int2ObjectOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Int2ObjectOpenCustomHashMap.this.key[Int2ObjectOpenCustomHashMap.this.n], Int2ObjectOpenCustomHashMap.this.value[Int2ObjectOpenCustomHashMap.this.n]
					)
				);
			}
			...
			while (pos-- != 0) {
				if (Int2ObjectOpenCustomHashMap.this.key[pos] != 0) {
					consumer.accept(new BasicEntry(Int2ObjectOpenCustomHashMap.this.key[pos], Int2ObjectOpenCustomHashMap.this.value[pos]));
				}
			}
		}
