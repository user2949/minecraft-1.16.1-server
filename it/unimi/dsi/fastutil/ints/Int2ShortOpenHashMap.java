...
public class Int2ShortOpenHashMap extends AbstractInt2ShortMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		int[] key = this.key;
		short[] value = this.value;
		Int2ShortOpenHashMap.MapIterator i = new Int2ShortOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Int2ShortOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.ints.Int2ShortMap.Entry> {
	...
	private class FastEntryIterator extends Int2ShortOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.ints.Int2ShortMap.Entry> {
