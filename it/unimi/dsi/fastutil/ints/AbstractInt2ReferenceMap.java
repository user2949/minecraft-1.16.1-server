...
public abstract class AbstractInt2ReferenceMap<V> extends AbstractInt2ReferenceFunction<V> implements Int2ReferenceMap<V>, Serializable {
	...
	public boolean containsKey(int k) {
		ObjectIterator<Entry<V>> i = this.int2ReferenceEntrySet().iterator();
		...
		return new AbstractIntSet() {
			...
			public IntIterator iterator() {
				return new IntIterator() {
					private final ObjectIterator<Entry<V>> i = Int2ReferenceMaps.fastIterator(AbstractInt2ReferenceMap.this);
	...
	public void putAll(Map<? extends Integer, ? extends V> m) {
		if (m instanceof Int2ReferenceMap) {
			ObjectIterator<Entry<V>> i = Int2ReferenceMaps.fastIterator((Int2ReferenceMap<V>)m);
	...
	public int hashCode() {
		int h = 0;
		int n = this.size();
		ObjectIterator<Entry<V>> i = Int2ReferenceMaps.fastIterator(this);
