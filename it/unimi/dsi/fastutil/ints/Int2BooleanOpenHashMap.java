...
public class Int2BooleanOpenHashMap extends AbstractInt2BooleanMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		int[] key = this.key;
		boolean[] value = this.value;
		Int2BooleanOpenHashMap.MapIterator i = new Int2BooleanOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Int2BooleanOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.ints.Int2BooleanMap.Entry> {
	...
	private class FastEntryIterator extends Int2BooleanOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.ints.Int2BooleanMap.Entry> {
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.ints.Int2BooleanMap.Entry> implements FastEntrySet {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.ints.Int2BooleanMap.Entry> consumer) {
			if (Int2BooleanOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Int2BooleanOpenHashMap.this.key[Int2BooleanOpenHashMap.this.n], Int2BooleanOpenHashMap.this.value[Int2BooleanOpenHashMap.this.n])
				);
			}
