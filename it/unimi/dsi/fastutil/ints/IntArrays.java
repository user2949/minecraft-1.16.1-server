...
public final class IntArrays {
	...
	public static final Strategy<int[]> HASH_STRATEGY = new IntArrays.ArrayHashStrategy();
	...
	private static final class ArrayHashStrategy implements Strategy<int[]>, Serializable {
				...
				while (true) {
					...
					while (b > c || (comparison = Integer.compare(x[b], v)) > 0) {
						...
						if (b > c) {
							...
							comparison = d - c;
							if (s > 1 && comparison > 1) {
								invokeAll(new IntArrays.ForkJoinQuickSort(x, this.from, this.from + s), new IntArrays.ForkJoinQuickSort(x, this.to - comparison, this.to));
							} else if (s > 1) {
				...
				while (true) {
					...
					while (b > c || (comparison = (t = Integer.compare(x[b], v)) == 0 ? Integer.compare(y[b], w) : t) > 0) {
						...
						if (b > c) {
							...
							comparison = d - c;
							if (s > 1 && comparison > 1) {
								invokeAll(new IntArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s), new IntArrays.ForkJoinQuickSort2(x, y, this.to - comparison, this.to));
							} else if (s > 1) {
