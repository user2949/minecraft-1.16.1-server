...
public class Int2CharOpenCustomHashMap extends AbstractInt2CharMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		int[] key = this.key;
		char[] value = this.value;
		Int2CharOpenCustomHashMap.MapIterator i = new Int2CharOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Int2CharOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.ints.Int2CharMap.Entry> {
	...
	private class FastEntryIterator extends Int2CharOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.ints.Int2CharMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.ints.Int2CharMap.Entry, java.util.Map.Entry<Integer, Character> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Int2CharOpenCustomHashMap.this.strategy.equals(Int2CharOpenCustomHashMap.this.key[this.index], (Integer)e.getKey())
					&& Int2CharOpenCustomHashMap.this.value[this.index] == (Character)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.ints.Int2CharMap.Entry> implements FastEntrySet {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.ints.Int2CharMap.Entry> consumer) {
			if (Int2CharOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Int2CharOpenCustomHashMap.this.key[Int2CharOpenCustomHashMap.this.n], Int2CharOpenCustomHashMap.this.value[Int2CharOpenCustomHashMap.this.n]
					)
				);
			}
