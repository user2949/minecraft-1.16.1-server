...
public class Int2FloatOpenCustomHashMap extends AbstractInt2FloatMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		int[] key = this.key;
		float[] value = this.value;
		Int2FloatOpenCustomHashMap.MapIterator i = new Int2FloatOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Int2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.ints.Int2FloatMap.Entry> {
	...
	private class FastEntryIterator extends Int2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.ints.Int2FloatMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.ints.Int2FloatMap.Entry, java.util.Map.Entry<Integer, Float> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Int2FloatOpenCustomHashMap.this.strategy.equals(Int2FloatOpenCustomHashMap.this.key[this.index], (Integer)e.getKey())
					&& Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((Float)e.getValue());
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.ints.Int2FloatMap.Entry> implements FastEntrySet {
				...
				if (e.getKey() == null || !(e.getKey() instanceof Integer)) {
					...
					if (Int2FloatOpenCustomHashMap.this.strategy.equals(k, 0)) {
						...
						if ((curr = key[pos = HashCommon.mix(Int2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Int2FloatOpenCustomHashMap.this.mask]) == 0) {
							return false;
						} else if (Int2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
				...
				if (e.getKey() != null && e.getKey() instanceof Integer) {
					if (e.getValue() != null && e.getValue() instanceof Float) {
						...
						if (Int2FloatOpenCustomHashMap.this.strategy.equals(k, 0)) {
							...
							if ((curr = key[pos = HashCommon.mix(Int2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Int2FloatOpenCustomHashMap.this.mask]) == 0) {
								return false;
							} else if (Int2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.ints.Int2FloatMap.Entry> consumer) {
			if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Int2FloatOpenCustomHashMap.this.key[Int2FloatOpenCustomHashMap.this.n], Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.n]
					)
				);
			}
