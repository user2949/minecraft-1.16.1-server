...
public class Int2ReferenceOpenHashMap<V> extends AbstractInt2ReferenceMap<V> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		int[] key = this.key;
		V[] value = this.value;
		Int2ReferenceOpenHashMap<V>.MapIterator i = new Int2ReferenceOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Int2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.ints.Int2ReferenceMap.Entry<V>> {
	...
	private class FastEntryIterator
		extends Int2ReferenceOpenHashMap<V>.MapIterator
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.ints.Int2ReferenceMap.Entry<V>> implements FastEntrySet<V> {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.ints.Int2ReferenceMap.Entry<V>> consumer) {
			if (Int2ReferenceOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Int2ReferenceOpenHashMap.this.key[Int2ReferenceOpenHashMap.this.n], Int2ReferenceOpenHashMap.this.value[Int2ReferenceOpenHashMap.this.n])
				);
			}
