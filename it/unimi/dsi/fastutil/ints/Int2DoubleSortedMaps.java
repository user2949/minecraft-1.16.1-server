...
import it.unimi.dsi.fastutil.ints.Int2DoubleMaps.EmptyMap;
import it.unimi.dsi.fastutil.ints.Int2DoubleMaps.SynchronizedMap;
import it.unimi.dsi.fastutil.ints.Int2DoubleMaps.UnmodifiableMap;
...
public final class Int2DoubleSortedMaps {
	...
	public static ObjectBidirectionalIterator<Entry> fastIterator(Int2DoubleSortedMap map) {
		ObjectSortedSet<Entry> entries = map.int2DoubleEntrySet();
		return entries instanceof FastSortedEntrySet ? ((FastSortedEntrySet)entries).fastIterator() : entries.iterator();
	}

	public static ObjectBidirectionalIterable<Entry> fastIterable(Int2DoubleSortedMap map) {
		ObjectSortedSet<Entry> entries = map.int2DoubleEntrySet();
	...
	public static class EmptySortedMap extends EmptyMap implements Int2DoubleSortedMap, Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Entry> int2DoubleEntrySet() {
			return ObjectSortedSets.EMPTY_SET;
		}

		@Deprecated
		@Override
		public ObjectSortedSet<java.util.Map.Entry<Integer, Double>> entrySet() {
			return ObjectSortedSets.EMPTY_SET;
		}
	...
	public static class Singleton extends Int2DoubleMaps.Singleton implements Int2DoubleSortedMap, Serializable, Cloneable {
		...
		public ObjectSortedSet<Entry> int2DoubleEntrySet() {
			if (this.entries == null) {
				this.entries = ObjectSortedSets.singleton(new BasicEntry(this.key, this.value), Int2DoubleSortedMaps.entryComparator(this.comparator));
			}
		...
		@Override
		public Int2DoubleSortedMap subMap(int from, int to) {
			return (Int2DoubleSortedMap)(this.compare(from, this.key) <= 0 && this.compare(this.key, to) < 0 ? this : Int2DoubleSortedMaps.EMPTY_MAP);
		}

		@Override
		public Int2DoubleSortedMap headMap(int to) {
			return (Int2DoubleSortedMap)(this.compare(this.key, to) < 0 ? this : Int2DoubleSortedMaps.EMPTY_MAP);
		}

		@Override
		public Int2DoubleSortedMap tailMap(int from) {
			return (Int2DoubleSortedMap)(this.compare(from, this.key) <= 0 ? this : Int2DoubleSortedMaps.EMPTY_MAP);
		}
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Int2DoubleSortedMap, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableSortedMap extends UnmodifiableMap implements Int2DoubleSortedMap, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Int2DoubleSortedMap sortedMap;
