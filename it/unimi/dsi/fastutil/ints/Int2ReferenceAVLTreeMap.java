...
public class Int2ReferenceAVLTreeMap<V> extends AbstractInt2ReferenceSortedMap<V> implements Serializable, Cloneable {
	...
	private Int2ReferenceAVLTreeMap.Entry<V> parent(Int2ReferenceAVLTreeMap.Entry<V> e) {
		if (e == this.tree) {
			...
			Int2ReferenceAVLTreeMap.Entry<V> x;
		...
		if (this.tree == null) {
			...
			while (q != null) {
				...
				if (!dir) {
					...
					if (y.balance() == -2) {
						Int2ReferenceAVLTreeMap.Entry<V> xx = y.left;
						...
						if (xx.balance() == 1) {
							...
							Int2ReferenceAVLTreeMap.Entry<V> wx = xx.right;
							xx.right = wx.left;
							wx.left = xx;
							y.left = wx.right;
							wx.right = y;
	...
	public ObjectSortedSet<it.unimi.dsi.fastutil.ints.Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
		if (this.entries == null) {
			this.entries = new AbstractObjectSortedSet<it.unimi.dsi.fastutil.ints.Int2ReferenceMap.Entry<V>>() {
				final Comparator<? super it.unimi.dsi.fastutil.ints.Int2ReferenceMap.Entry<V>> comparator = (x, y) -> Int2ReferenceAVLTreeMap.this.actualComparator
	...
	private class KeySet extends AbstractInt2ReferenceSortedMap<V>.KeySet {
		private KeySet() {
			super(Int2ReferenceAVLTreeMap.this);
		}
	...
	private final class Submap extends AbstractInt2ReferenceSortedMap<V> implements Serializable {
		...
		public V get(int k) {
			...
			return this.in(k) && (e = Int2ReferenceAVLTreeMap.this.findKey(k)) != null ? e.value : this.defRetValue;
		}
		...
		private class SubmapEntryIterator
			extends Int2ReferenceAVLTreeMap<V>.Submap.SubmapIterator
			implements ObjectListIterator<it.unimi.dsi.fastutil.ints.Int2ReferenceMap.Entry<V>> {
			SubmapEntryIterator() {
			}
