...
public class Int2LongOpenCustomHashMap extends AbstractInt2LongMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		int[] key = this.key;
		long[] value = this.value;
		Int2LongOpenCustomHashMap.MapIterator i = new Int2LongOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Int2LongOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.ints.Int2LongMap.Entry> {
	...
	private class FastEntryIterator extends Int2LongOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.ints.Int2LongMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.ints.Int2LongMap.Entry, java.util.Map.Entry<Integer, Long> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Int2LongOpenCustomHashMap.this.strategy.equals(Int2LongOpenCustomHashMap.this.key[this.index], (Integer)e.getKey())
					&& Int2LongOpenCustomHashMap.this.value[this.index] == (Long)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.ints.Int2LongMap.Entry> implements FastEntrySet {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.ints.Int2LongMap.Entry> consumer) {
			if (Int2LongOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Int2LongOpenCustomHashMap.this.key[Int2LongOpenCustomHashMap.this.n], Int2LongOpenCustomHashMap.this.value[Int2LongOpenCustomHashMap.this.n]
					)
				);
			}
