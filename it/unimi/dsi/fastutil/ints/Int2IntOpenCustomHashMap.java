...
public class Int2IntOpenCustomHashMap extends AbstractInt2IntMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		int[] key = this.key;
		int[] value = this.value;
		Int2IntOpenCustomHashMap.MapIterator i = new Int2IntOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Int2IntOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.ints.Int2IntMap.Entry> {
	...
	private class FastEntryIterator extends Int2IntOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.ints.Int2IntMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.ints.Int2IntMap.Entry, java.util.Map.Entry<Integer, Integer> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Int2IntOpenCustomHashMap.this.strategy.equals(Int2IntOpenCustomHashMap.this.key[this.index], (Integer)e.getKey())
					&& Int2IntOpenCustomHashMap.this.value[this.index] == (Integer)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.ints.Int2IntMap.Entry> implements FastEntrySet {
				...
				if (e.getKey() == null || !(e.getKey() instanceof Integer)) {
					...
					if (Int2IntOpenCustomHashMap.this.strategy.equals(k, 0)) {
						...
						if ((curr = key[pos = HashCommon.mix(Int2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Int2IntOpenCustomHashMap.this.mask]) == 0) {
							return false;
						} else if (Int2IntOpenCustomHashMap.this.strategy.equals(k, curr)) {
				...
				if (e.getKey() != null && e.getKey() instanceof Integer) {
					if (e.getValue() != null && e.getValue() instanceof Integer) {
						...
						if (Int2IntOpenCustomHashMap.this.strategy.equals(k, 0)) {
							...
							if ((curr = key[pos = HashCommon.mix(Int2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Int2IntOpenCustomHashMap.this.mask]) == 0) {
								return false;
							} else if (Int2IntOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.ints.Int2IntMap.Entry> consumer) {
			if (Int2IntOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Int2IntOpenCustomHashMap.this.key[Int2IntOpenCustomHashMap.this.n], Int2IntOpenCustomHashMap.this.value[Int2IntOpenCustomHashMap.this.n])
				);
			}
