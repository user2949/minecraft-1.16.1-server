...
public class Float2FloatOpenCustomHashMap extends AbstractFloat2FloatMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		float[] key = this.key;
		float[] value = this.value;
		Float2FloatOpenCustomHashMap.MapIterator i = new Float2FloatOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Float2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.floats.Float2FloatMap.Entry> {
	...
	private class FastEntryIterator extends Float2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.floats.Float2FloatMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.floats.Float2FloatMap.Entry, java.util.Map.Entry<Float, Float> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Float2FloatOpenCustomHashMap.this.strategy.equals(Float2FloatOpenCustomHashMap.this.key[this.index], (Float)e.getKey())
					&& Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((Float)e.getValue());
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.floats.Float2FloatMap.Entry> implements FastEntrySet {
				...
				if (e.getKey() == null || !(e.getKey() instanceof Float)) {
					...
					if (Float2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0F)) {
						...
						if (Float.floatToIntBits(
							...
							== 0) {
							return false;
						} else if (Float2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
					...
					if (e.getValue() != null && e.getValue() instanceof Float) {
						...
						if (Float2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0F)) {
							...
							if (Float.floatToIntBits(
								...
								== 0) {
								return false;
							} else if (Float2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.floats.Float2FloatMap.Entry> consumer) {
			if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Float2FloatOpenCustomHashMap.this.key[Float2FloatOpenCustomHashMap.this.n], Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.n]
					)
				);
			}
