...
public class Float2DoubleOpenCustomHashMap extends AbstractFloat2DoubleMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		float[] key = this.key;
		double[] value = this.value;
		Float2DoubleOpenCustomHashMap.MapIterator i = new Float2DoubleOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Float2DoubleOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.floats.Float2DoubleMap.Entry> {
	...
	private class FastEntryIterator
		...
		implements ObjectIterator<it.unimi.dsi.fastutil.floats.Float2DoubleMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.floats.Float2DoubleMap.Entry, java.util.Map.Entry<Float, Double> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Float2DoubleOpenCustomHashMap.this.strategy.equals(Float2DoubleOpenCustomHashMap.this.key[this.index], (Float)e.getKey())
					&& Double.doubleToLongBits(Float2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits((Double)e.getValue());
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.floats.Float2DoubleMap.Entry> implements FastEntrySet {
				...
				if (e.getKey() == null || !(e.getKey() instanceof Float)) {
					...
					if (Float2DoubleOpenCustomHashMap.this.strategy.equals(k, 0.0F)) {
						...
						if (Float.floatToIntBits(
							...
							== 0) {
							return false;
						} else if (Float2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
					...
					if (e.getValue() != null && e.getValue() instanceof Double) {
						...
						if (Float2DoubleOpenCustomHashMap.this.strategy.equals(k, 0.0F)) {
							...
							if (Float.floatToIntBits(
								...
								== 0) {
								return false;
							} else if (Float2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.floats.Float2DoubleMap.Entry> consumer) {
			if (Float2DoubleOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Float2DoubleOpenCustomHashMap.this.key[Float2DoubleOpenCustomHashMap.this.n],
						Float2DoubleOpenCustomHashMap.this.value[Float2DoubleOpenCustomHashMap.this.n]
					)
				);
			}
