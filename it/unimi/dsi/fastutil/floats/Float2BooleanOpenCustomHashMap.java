...
public class Float2BooleanOpenCustomHashMap extends AbstractFloat2BooleanMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		float[] key = this.key;
		boolean[] value = this.value;
		Float2BooleanOpenCustomHashMap.MapIterator i = new Float2BooleanOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Float2BooleanOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.floats.Float2BooleanMap.Entry> {
	...
	private class FastEntryIterator
		...
		implements ObjectIterator<it.unimi.dsi.fastutil.floats.Float2BooleanMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.floats.Float2BooleanMap.Entry, java.util.Map.Entry<Float, Boolean> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Float2BooleanOpenCustomHashMap.this.strategy.equals(Float2BooleanOpenCustomHashMap.this.key[this.index], (Float)e.getKey())
					&& Float2BooleanOpenCustomHashMap.this.value[this.index] == (Boolean)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.floats.Float2BooleanMap.Entry> implements FastEntrySet {
				...
				if (e.getKey() == null || !(e.getKey() instanceof Float)) {
					...
					if (Float2BooleanOpenCustomHashMap.this.strategy.equals(k, 0.0F)) {
						...
						if (Float.floatToIntBits(
							...
							== 0) {
							return false;
						} else if (Float2BooleanOpenCustomHashMap.this.strategy.equals(k, curr)) {
					...
					if (e.getValue() != null && e.getValue() instanceof Boolean) {
						...
						if (Float2BooleanOpenCustomHashMap.this.strategy.equals(k, 0.0F)) {
							...
							if (Float.floatToIntBits(
								...
								== 0) {
								return false;
							} else if (Float2BooleanOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.floats.Float2BooleanMap.Entry> consumer) {
			if (Float2BooleanOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Float2BooleanOpenCustomHashMap.this.key[Float2BooleanOpenCustomHashMap.this.n],
						Float2BooleanOpenCustomHashMap.this.value[Float2BooleanOpenCustomHashMap.this.n]
					)
				);
			}
