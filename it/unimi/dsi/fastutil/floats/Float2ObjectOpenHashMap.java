...
public class Float2ObjectOpenHashMap<V> extends AbstractFloat2ObjectMap<V> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		float[] key = this.key;
		V[] value = this.value;
		Float2ObjectOpenHashMap<V>.MapIterator i = new Float2ObjectOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Float2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.floats.Float2ObjectMap.Entry<V>> {
	...
	private class FastEntryIterator
		extends Float2ObjectOpenHashMap<V>.MapIterator
	...
	final class MapEntry implements it.unimi.dsi.fastutil.floats.Float2ObjectMap.Entry<V>, java.util.Map.Entry<Float, V> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Float.floatToIntBits(Float2ObjectOpenHashMap.this.key[this.index]) == Float.floatToIntBits((Float)e.getKey())
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.floats.Float2ObjectMap.Entry<V>> implements FastEntrySet<V> {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.floats.Float2ObjectMap.Entry<V>> consumer) {
			if (Float2ObjectOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Float2ObjectOpenHashMap.this.key[Float2ObjectOpenHashMap.this.n], Float2ObjectOpenHashMap.this.value[Float2ObjectOpenHashMap.this.n])
				);
			}
	...
	private class MapIterator {
		...
		private void shiftKeys(int pos) {
			...
			while (true) {
				...
				float curr;
				for (pos = pos + 1 & Float2ObjectOpenHashMap.this.mask; Float.floatToIntBits(curr = key[pos]) != 0; pos = pos + 1 & Float2ObjectOpenHashMap.this.mask) {
