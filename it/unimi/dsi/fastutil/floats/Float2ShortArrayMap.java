...
public class Float2ShortArrayMap extends AbstractFloat2ShortMap implements Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.floats.Float2ShortMap.Entry> implements FastEntrySet {
		private EntrySet() {
		}

		@Override
		public ObjectIterator<it.unimi.dsi.fastutil.floats.Float2ShortMap.Entry> iterator() {
			return new ObjectIterator<it.unimi.dsi.fastutil.floats.Float2ShortMap.Entry>() {
				int curr = -1;
				int next = 0;
				...
				public it.unimi.dsi.fastutil.floats.Float2ShortMap.Entry next() {
					if (!this.hasNext()) {
						...
						return new BasicEntry(Float2ShortArrayMap.this.key[this.curr = this.next], Float2ShortArrayMap.this.value[this.next++]);
					}
				}
