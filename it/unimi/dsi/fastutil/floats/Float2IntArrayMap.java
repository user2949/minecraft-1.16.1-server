...
public class Float2IntArrayMap extends AbstractFloat2IntMap implements Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.floats.Float2IntMap.Entry> implements FastEntrySet {
		private EntrySet() {
		}

		@Override
		public ObjectIterator<it.unimi.dsi.fastutil.floats.Float2IntMap.Entry> iterator() {
			return new ObjectIterator<it.unimi.dsi.fastutil.floats.Float2IntMap.Entry>() {
				int curr = -1;
				int next = 0;
				...
				public it.unimi.dsi.fastutil.floats.Float2IntMap.Entry next() {
					if (!this.hasNext()) {
						...
						return new BasicEntry(Float2IntArrayMap.this.key[this.curr = this.next], Float2IntArrayMap.this.value[this.next++]);
					}
				}
