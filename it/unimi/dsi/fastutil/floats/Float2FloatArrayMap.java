...
public class Float2FloatArrayMap extends AbstractFloat2FloatMap implements Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.floats.Float2FloatMap.Entry> implements FastEntrySet {
		private EntrySet() {
		}

		@Override
		public ObjectIterator<it.unimi.dsi.fastutil.floats.Float2FloatMap.Entry> iterator() {
			return new ObjectIterator<it.unimi.dsi.fastutil.floats.Float2FloatMap.Entry>() {
				int curr = -1;
				int next = 0;
				...
				public it.unimi.dsi.fastutil.floats.Float2FloatMap.Entry next() {
					if (!this.hasNext()) {
						...
						return new BasicEntry(Float2FloatArrayMap.this.key[this.curr = this.next], Float2FloatArrayMap.this.value[this.next++]);
					}
				}
