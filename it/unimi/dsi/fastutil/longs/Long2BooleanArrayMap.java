...
public class Long2BooleanArrayMap extends AbstractLong2BooleanMap implements Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.longs.Long2BooleanMap.Entry> implements FastEntrySet {
		private EntrySet() {
		}

		@Override
		public ObjectIterator<it.unimi.dsi.fastutil.longs.Long2BooleanMap.Entry> iterator() {
			return new ObjectIterator<it.unimi.dsi.fastutil.longs.Long2BooleanMap.Entry>() {
				int curr = -1;
				int next = 0;
				...
				public it.unimi.dsi.fastutil.longs.Long2BooleanMap.Entry next() {
					if (!this.hasNext()) {
						...
						return new BasicEntry(Long2BooleanArrayMap.this.key[this.curr = this.next], Long2BooleanArrayMap.this.value[this.next++]);
					}
				}
