...
public class Long2IntOpenHashMap extends AbstractLong2IntMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		long[] key = this.key;
		int[] value = this.value;
		Long2IntOpenHashMap.MapIterator i = new Long2IntOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Long2IntOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.longs.Long2IntMap.Entry> {
	...
	private class FastEntryIterator extends Long2IntOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.longs.Long2IntMap.Entry> {
