...
public class Long2BooleanOpenCustomHashMap extends AbstractLong2BooleanMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		long[] key = this.key;
		boolean[] value = this.value;
		Long2BooleanOpenCustomHashMap.MapIterator i = new Long2BooleanOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Long2BooleanOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.longs.Long2BooleanMap.Entry> {
	...
	private class FastEntryIterator extends Long2BooleanOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.longs.Long2BooleanMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.longs.Long2BooleanMap.Entry, java.util.Map.Entry<Long, Boolean> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Long2BooleanOpenCustomHashMap.this.strategy.equals(Long2BooleanOpenCustomHashMap.this.key[this.index], (Long)e.getKey())
					&& Long2BooleanOpenCustomHashMap.this.value[this.index] == (Boolean)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.longs.Long2BooleanMap.Entry> implements FastEntrySet {
				...
				if (e.getKey() == null || !(e.getKey() instanceof Long)) {
					...
					if (Long2BooleanOpenCustomHashMap.this.strategy.equals(k, 0L)) {
						...
						if ((curr = key[pos = HashCommon.mix(Long2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Long2BooleanOpenCustomHashMap.this.mask]) == 0L) {
							return false;
						} else if (Long2BooleanOpenCustomHashMap.this.strategy.equals(k, curr)) {
				...
				if (e.getKey() != null && e.getKey() instanceof Long) {
					if (e.getValue() != null && e.getValue() instanceof Boolean) {
						...
						if (Long2BooleanOpenCustomHashMap.this.strategy.equals(k, 0L)) {
							...
							if ((curr = key[pos = HashCommon.mix(Long2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Long2BooleanOpenCustomHashMap.this.mask]) == 0L) {
								return false;
							} else if (Long2BooleanOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.longs.Long2BooleanMap.Entry> consumer) {
			if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Long2BooleanOpenCustomHashMap.this.key[Long2BooleanOpenCustomHashMap.this.n],
						Long2BooleanOpenCustomHashMap.this.value[Long2BooleanOpenCustomHashMap.this.n]
					)
				);
			}
			...
			while (pos-- != 0) {
				if (Long2BooleanOpenCustomHashMap.this.key[pos] != 0L) {
					consumer.accept(new BasicEntry(Long2BooleanOpenCustomHashMap.this.key[pos], Long2BooleanOpenCustomHashMap.this.value[pos]));
				}
			}
		}
