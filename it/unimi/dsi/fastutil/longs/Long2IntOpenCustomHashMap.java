...
public class Long2IntOpenCustomHashMap extends AbstractLong2IntMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		long[] key = this.key;
		int[] value = this.value;
		Long2IntOpenCustomHashMap.MapIterator i = new Long2IntOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Long2IntOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.longs.Long2IntMap.Entry> {
	...
	private class FastEntryIterator extends Long2IntOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.longs.Long2IntMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.longs.Long2IntMap.Entry, java.util.Map.Entry<Long, Integer> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Long2IntOpenCustomHashMap.this.strategy.equals(Long2IntOpenCustomHashMap.this.key[this.index], (Long)e.getKey())
					&& Long2IntOpenCustomHashMap.this.value[this.index] == (Integer)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.longs.Long2IntMap.Entry> implements FastEntrySet {
		private MapEntrySet() {
		}
				...
				if (e.getKey() == null || !(e.getKey() instanceof Long)) {
					...
					if (Long2IntOpenCustomHashMap.this.strategy.equals(k, 0L)) {
						...
						if ((curr = key[pos = HashCommon.mix(Long2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Long2IntOpenCustomHashMap.this.mask]) == 0L) {
							return false;
						} else if (Long2IntOpenCustomHashMap.this.strategy.equals(k, curr)) {
				...
				if (e.getKey() != null && e.getKey() instanceof Long) {
					if (e.getValue() != null && e.getValue() instanceof Integer) {
						...
						if (Long2IntOpenCustomHashMap.this.strategy.equals(k, 0L)) {
							...
							if ((curr = key[pos = HashCommon.mix(Long2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Long2IntOpenCustomHashMap.this.mask]) == 0L) {
								return false;
							} else if (Long2IntOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.longs.Long2IntMap.Entry> consumer) {
			if (Long2IntOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Long2IntOpenCustomHashMap.this.key[Long2IntOpenCustomHashMap.this.n], Long2IntOpenCustomHashMap.this.value[Long2IntOpenCustomHashMap.this.n]
					)
				);
			}
