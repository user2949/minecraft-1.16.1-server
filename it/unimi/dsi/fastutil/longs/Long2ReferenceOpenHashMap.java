...
public class Long2ReferenceOpenHashMap<V> extends AbstractLong2ReferenceMap<V> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		long[] key = this.key;
		V[] value = this.value;
		Long2ReferenceOpenHashMap<V>.MapIterator i = new Long2ReferenceOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Long2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.longs.Long2ReferenceMap.Entry<V>> {
	...
	private class FastEntryIterator
		extends Long2ReferenceOpenHashMap<V>.MapIterator
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.longs.Long2ReferenceMap.Entry<V>> implements FastEntrySet<V> {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.longs.Long2ReferenceMap.Entry<V>> consumer) {
			if (Long2ReferenceOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Long2ReferenceOpenHashMap.this.key[Long2ReferenceOpenHashMap.this.n], Long2ReferenceOpenHashMap.this.value[Long2ReferenceOpenHashMap.this.n]
					)
				);
			}
