...
import it.unimi.dsi.fastutil.longs.Long2DoubleMaps.EmptyMap;
import it.unimi.dsi.fastutil.longs.Long2DoubleMaps.SynchronizedMap;
import it.unimi.dsi.fastutil.longs.Long2DoubleMaps.UnmodifiableMap;
...
public final class Long2DoubleSortedMaps {
	...
	public static ObjectBidirectionalIterator<Entry> fastIterator(Long2DoubleSortedMap map) {
		ObjectSortedSet<Entry> entries = map.long2DoubleEntrySet();
		return entries instanceof FastSortedEntrySet ? ((FastSortedEntrySet)entries).fastIterator() : entries.iterator();
	}

	public static ObjectBidirectionalIterable<Entry> fastIterable(Long2DoubleSortedMap map) {
		ObjectSortedSet<Entry> entries = map.long2DoubleEntrySet();
	...
	public static class EmptySortedMap extends EmptyMap implements Long2DoubleSortedMap, Serializable, Cloneable {
		...
		@Deprecated
		@Override
		public ObjectSortedSet<java.util.Map.Entry<Long, Double>> entrySet() {
			return ObjectSortedSets.EMPTY_SET;
		}
	...
	public static class Singleton extends Long2DoubleMaps.Singleton implements Long2DoubleSortedMap, Serializable, Cloneable {
		...
		public ObjectSortedSet<Entry> long2DoubleEntrySet() {
			if (this.entries == null) {
				this.entries = ObjectSortedSets.singleton(new BasicEntry(this.key, this.value), Long2DoubleSortedMaps.entryComparator(this.comparator));
			}
		...
		@Override
		public Long2DoubleSortedMap subMap(long from, long to) {
			return (Long2DoubleSortedMap)(this.compare(from, this.key) <= 0 && this.compare(this.key, to) < 0 ? this : Long2DoubleSortedMaps.EMPTY_MAP);
		}

		@Override
		public Long2DoubleSortedMap headMap(long to) {
			return (Long2DoubleSortedMap)(this.compare(this.key, to) < 0 ? this : Long2DoubleSortedMaps.EMPTY_MAP);
		}

		@Override
		public Long2DoubleSortedMap tailMap(long from) {
			return (Long2DoubleSortedMap)(this.compare(from, this.key) <= 0 ? this : Long2DoubleSortedMaps.EMPTY_MAP);
		}
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Long2DoubleSortedMap, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableSortedMap extends UnmodifiableMap implements Long2DoubleSortedMap, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Long2DoubleSortedMap sortedMap;
