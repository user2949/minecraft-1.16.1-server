...
import it.unimi.dsi.fastutil.longs.Long2FloatMaps.EmptyMap;
import it.unimi.dsi.fastutil.longs.Long2FloatMaps.SynchronizedMap;
import it.unimi.dsi.fastutil.longs.Long2FloatMaps.UnmodifiableMap;
...
public final class Long2FloatSortedMaps {
	...
	public static ObjectBidirectionalIterator<Entry> fastIterator(Long2FloatSortedMap map) {
		ObjectSortedSet<Entry> entries = map.long2FloatEntrySet();
		return entries instanceof FastSortedEntrySet ? ((FastSortedEntrySet)entries).fastIterator() : entries.iterator();
	}

	public static ObjectBidirectionalIterable<Entry> fastIterable(Long2FloatSortedMap map) {
		ObjectSortedSet<Entry> entries = map.long2FloatEntrySet();
	...
	public static class EmptySortedMap extends EmptyMap implements Long2FloatSortedMap, Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Entry> long2FloatEntrySet() {
			return ObjectSortedSets.EMPTY_SET;
		}

		@Deprecated
		@Override
		public ObjectSortedSet<java.util.Map.Entry<Long, Float>> entrySet() {
			return ObjectSortedSets.EMPTY_SET;
		}
	...
	public static class Singleton extends Long2FloatMaps.Singleton implements Long2FloatSortedMap, Serializable, Cloneable {
		...
		public ObjectSortedSet<Entry> long2FloatEntrySet() {
			if (this.entries == null) {
				this.entries = ObjectSortedSets.singleton(new BasicEntry(this.key, this.value), Long2FloatSortedMaps.entryComparator(this.comparator));
			}
		...
		@Override
		public Long2FloatSortedMap subMap(long from, long to) {
			return (Long2FloatSortedMap)(this.compare(from, this.key) <= 0 && this.compare(this.key, to) < 0 ? this : Long2FloatSortedMaps.EMPTY_MAP);
		}

		@Override
		public Long2FloatSortedMap headMap(long to) {
			return (Long2FloatSortedMap)(this.compare(this.key, to) < 0 ? this : Long2FloatSortedMaps.EMPTY_MAP);
		}

		@Override
		public Long2FloatSortedMap tailMap(long from) {
			return (Long2FloatSortedMap)(this.compare(from, this.key) <= 0 ? this : Long2FloatSortedMaps.EMPTY_MAP);
		}
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Long2FloatSortedMap, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableSortedMap extends UnmodifiableMap implements Long2FloatSortedMap, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Long2FloatSortedMap sortedMap;
