...
import it.unimi.dsi.fastutil.longs.Long2BooleanMaps.EmptyMap;
import it.unimi.dsi.fastutil.longs.Long2BooleanMaps.SynchronizedMap;
import it.unimi.dsi.fastutil.longs.Long2BooleanMaps.UnmodifiableMap;
...
public final class Long2BooleanSortedMaps {
	...
	public static ObjectBidirectionalIterator<Entry> fastIterator(Long2BooleanSortedMap map) {
		ObjectSortedSet<Entry> entries = map.long2BooleanEntrySet();
		return entries instanceof FastSortedEntrySet ? ((FastSortedEntrySet)entries).fastIterator() : entries.iterator();
	}

	public static ObjectBidirectionalIterable<Entry> fastIterable(Long2BooleanSortedMap map) {
		ObjectSortedSet<Entry> entries = map.long2BooleanEntrySet();
	...
	public static class EmptySortedMap extends EmptyMap implements Long2BooleanSortedMap, Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Entry> long2BooleanEntrySet() {
			return ObjectSortedSets.EMPTY_SET;
		}

		@Deprecated
		@Override
		public ObjectSortedSet<java.util.Map.Entry<Long, Boolean>> entrySet() {
			return ObjectSortedSets.EMPTY_SET;
		}
	...
	public static class Singleton extends Long2BooleanMaps.Singleton implements Long2BooleanSortedMap, Serializable, Cloneable {
		...
		public ObjectSortedSet<Entry> long2BooleanEntrySet() {
			if (this.entries == null) {
				this.entries = ObjectSortedSets.singleton(new BasicEntry(this.key, this.value), Long2BooleanSortedMaps.entryComparator(this.comparator));
			}
		...
		@Override
		public Long2BooleanSortedMap subMap(long from, long to) {
			return (Long2BooleanSortedMap)(this.compare(from, this.key) <= 0 && this.compare(this.key, to) < 0 ? this : Long2BooleanSortedMaps.EMPTY_MAP);
		}

		@Override
		public Long2BooleanSortedMap headMap(long to) {
			return (Long2BooleanSortedMap)(this.compare(this.key, to) < 0 ? this : Long2BooleanSortedMaps.EMPTY_MAP);
		}

		@Override
		public Long2BooleanSortedMap tailMap(long from) {
			return (Long2BooleanSortedMap)(this.compare(from, this.key) <= 0 ? this : Long2BooleanSortedMaps.EMPTY_MAP);
		}
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Long2BooleanSortedMap, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableSortedMap extends UnmodifiableMap implements Long2BooleanSortedMap, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Long2BooleanSortedMap sortedMap;
