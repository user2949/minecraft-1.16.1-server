...
public class Long2FloatOpenHashMap extends AbstractLong2FloatMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		long[] key = this.key;
		float[] value = this.value;
		Long2FloatOpenHashMap.MapIterator i = new Long2FloatOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Long2FloatOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.longs.Long2FloatMap.Entry> {
	...
	private class FastEntryIterator extends Long2FloatOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.longs.Long2FloatMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.longs.Long2FloatMap.Entry, java.util.Map.Entry<Long, Float> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Long2FloatOpenHashMap.this.key[this.index] == (Long)e.getKey()
					&& Float.floatToIntBits(Long2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits((Float)e.getValue());
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.longs.Long2FloatMap.Entry> implements FastEntrySet {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.longs.Long2FloatMap.Entry> consumer) {
			if (Long2FloatOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Long2FloatOpenHashMap.this.key[Long2FloatOpenHashMap.this.n], Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.n])
				);
			}
