...
public class Long2ObjectAVLTreeMap<V> extends AbstractLong2ObjectSortedMap<V> implements Serializable, Cloneable {
	...
	private Long2ObjectAVLTreeMap.Entry<V> parent(Long2ObjectAVLTreeMap.Entry<V> e) {
		if (e == this.tree) {
			...
			Long2ObjectAVLTreeMap.Entry<V> x;
		...
		if (this.tree == null) {
			...
			while (q != null) {
				...
				if (!dir) {
					...
					if (y.balance() == -2) {
						Long2ObjectAVLTreeMap.Entry<V> xx = y.left;
						...
						if (xx.balance() == 1) {
							...
							Long2ObjectAVLTreeMap.Entry<V> wx = xx.right;
							xx.right = wx.left;
							wx.left = xx;
							y.left = wx.right;
							wx.right = y;
	...
	public ObjectSortedSet<it.unimi.dsi.fastutil.longs.Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
		if (this.entries == null) {
			this.entries = new AbstractObjectSortedSet<it.unimi.dsi.fastutil.longs.Long2ObjectMap.Entry<V>>() {
				final Comparator<? super it.unimi.dsi.fastutil.longs.Long2ObjectMap.Entry<V>> comparator = (x, y) -> Long2ObjectAVLTreeMap.this.actualComparator
	...
	private class EntryIterator extends Long2ObjectAVLTreeMap<V>.TreeIterator implements ObjectListIterator<it.unimi.dsi.fastutil.longs.Long2ObjectMap.Entry<V>> {
		EntryIterator() {
		}
	...
	private final class Submap extends AbstractLong2ObjectSortedMap<V> implements Serializable {
		...
		public V get(long k) {
			...
			return this.in(k) && (e = Long2ObjectAVLTreeMap.this.findKey(k)) != null ? e.value : this.defRetValue;
		}
		...
		private class SubmapEntryIterator
			extends Long2ObjectAVLTreeMap<V>.Submap.SubmapIterator
