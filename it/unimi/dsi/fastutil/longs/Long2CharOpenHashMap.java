...
public class Long2CharOpenHashMap extends AbstractLong2CharMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		long[] key = this.key;
		char[] value = this.value;
		Long2CharOpenHashMap.MapIterator i = new Long2CharOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Long2CharOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.longs.Long2CharMap.Entry> {
	...
	private class FastEntryIterator extends Long2CharOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.longs.Long2CharMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.longs.Long2CharMap.Entry, java.util.Map.Entry<Long, Character> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Long2CharOpenHashMap.this.key[this.index] == (Long)e.getKey() && Long2CharOpenHashMap.this.value[this.index] == (Character)e.getValue();
			}
		}
