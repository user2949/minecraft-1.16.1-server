...
import it.unimi.dsi.fastutil.longs.Long2FloatFunctions.EmptyFunction;
import it.unimi.dsi.fastutil.longs.Long2FloatFunctions.SynchronizedFunction;
import it.unimi.dsi.fastutil.longs.Long2FloatFunctions.UnmodifiableFunction;
...
public final class Long2FloatMaps {
	...
	public static ObjectIterator<Entry> fastIterator(Long2FloatMap map) {
		ObjectSet<Entry> entries = map.long2FloatEntrySet();
		return entries instanceof FastEntrySet ? ((FastEntrySet)entries).fastIterator() : entries.iterator();
	}

	public static void fastForEach(Long2FloatMap map, Consumer<? super Entry> consumer) {
		ObjectSet<Entry> entries = map.long2FloatEntrySet();
	...
	public static ObjectIterable<Entry> fastIterable(Long2FloatMap map) {
		final ObjectSet<Entry> entries = map.long2FloatEntrySet();
	...
	public static class EmptyMap extends EmptyFunction implements Long2FloatMap, Serializable, Cloneable {
	...
	public static class Singleton extends Long2FloatFunctions.Singleton implements Long2FloatMap, Serializable, Cloneable {
		...
		@Deprecated
		@Override
		public ObjectSet<java.util.Map.Entry<Long, Float>> entrySet() {
	...
	public static class SynchronizedMap extends SynchronizedFunction implements Long2FloatMap, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableMap extends UnmodifiableFunction implements Long2FloatMap, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Long2FloatMap map;
		protected transient ObjectSet<Entry> entries;
		protected transient LongSet keys;
