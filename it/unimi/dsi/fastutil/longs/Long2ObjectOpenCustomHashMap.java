...
public class Long2ObjectOpenCustomHashMap<V> extends AbstractLong2ObjectMap<V> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		long[] key = this.key;
		V[] value = this.value;
		Long2ObjectOpenCustomHashMap<V>.MapIterator i = new Long2ObjectOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Long2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.longs.Long2ObjectMap.Entry<V>> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.longs.Long2ObjectMap.Entry<V>, java.util.Map.Entry<Long, V> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Long2ObjectOpenCustomHashMap.this.strategy.equals(Long2ObjectOpenCustomHashMap.this.key[this.index], (Long)e.getKey())
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.longs.Long2ObjectMap.Entry<V>> implements FastEntrySet<V> {
				...
				if (e.getKey() != null && e.getKey() instanceof Long) {
					...
					if (Long2ObjectOpenCustomHashMap.this.strategy.equals(k, 0L)) {
						...
						if ((curr = key[pos = HashCommon.mix(Long2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Long2ObjectOpenCustomHashMap.this.mask]) == 0L) {
							return false;
						} else if (Long2ObjectOpenCustomHashMap.this.strategy.equals(k, curr)) {
			...
			if (!(o instanceof java.util.Map.Entry)) {
				...
				if (e.getKey() != null && e.getKey() instanceof Long) {
					...
					if (Long2ObjectOpenCustomHashMap.this.strategy.equals(k, 0L)) {
						...
						if ((curr = key[pos = HashCommon.mix(Long2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Long2ObjectOpenCustomHashMap.this.mask]) == 0L) {
							return false;
						} else if (Long2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.longs.Long2ObjectMap.Entry<V>> consumer) {
			if (Long2ObjectOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Long2ObjectOpenCustomHashMap.this.key[Long2ObjectOpenCustomHashMap.this.n], Long2ObjectOpenCustomHashMap.this.value[Long2ObjectOpenCustomHashMap.this.n]
					)
				);
			}
