...
public class Reference2BooleanOpenHashMap<K> extends AbstractReference2BooleanMap<K> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		boolean[] value = this.value;
		Reference2BooleanOpenHashMap<K>.MapIterator i = new Reference2BooleanOpenHashMap.MapIterator();
	...
	private class EntryIterator
		extends Reference2BooleanOpenHashMap<K>.MapIterator
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Reference2BooleanMap.Entry<K>> implements FastEntrySet<K> {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Reference2BooleanMap.Entry<K>> consumer) {
			if (Reference2BooleanOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Reference2BooleanOpenHashMap.this.key[Reference2BooleanOpenHashMap.this.n], Reference2BooleanOpenHashMap.this.value[Reference2BooleanOpenHashMap.this.n]
					)
				);
			}
