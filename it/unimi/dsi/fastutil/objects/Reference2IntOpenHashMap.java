...
public class Reference2IntOpenHashMap<K> extends AbstractReference2IntMap<K> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		int[] value = this.value;
		Reference2IntOpenHashMap<K>.MapIterator i = new Reference2IntOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Reference2IntOpenHashMap<K>.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.objects.Reference2IntMap.Entry<K>> {
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Reference2IntMap.Entry<K>> implements FastEntrySet<K> {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Reference2IntMap.Entry<K>> consumer) {
			if (Reference2IntOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Reference2IntOpenHashMap.this.key[Reference2IntOpenHashMap.this.n], Reference2IntOpenHashMap.this.value[Reference2IntOpenHashMap.this.n])
				);
			}
