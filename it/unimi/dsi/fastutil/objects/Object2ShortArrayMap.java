...
public class Object2ShortArrayMap<K> extends AbstractObject2ShortMap<K> implements Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Object2ShortMap.Entry<K>> implements FastEntrySet<K> {
		private EntrySet() {
		}

		@Override
		public ObjectIterator<it.unimi.dsi.fastutil.objects.Object2ShortMap.Entry<K>> iterator() {
			return new ObjectIterator<it.unimi.dsi.fastutil.objects.Object2ShortMap.Entry<K>>() {
				int curr = -1;
				int next = 0;
				...
				public it.unimi.dsi.fastutil.objects.Object2ShortMap.Entry<K> next() {
					if (!this.hasNext()) {
						...
						return new BasicEntry<>((K)Object2ShortArrayMap.this.key[this.curr = this.next], Object2ShortArrayMap.this.value[this.next++]);
					}
				}
