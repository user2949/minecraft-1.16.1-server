...
public class Object2CharOpenCustomHashMap<K> extends AbstractObject2CharMap<K> implements Serializable, Cloneable, Hash {
	...
	public Object2CharOpenCustomHashMap(int expected, float f, Strategy<K> strategy) {
	...
	public Object2CharOpenCustomHashMap(int expected, Strategy<K> strategy) {
		this(expected, 0.75F, strategy);
	}

	public Object2CharOpenCustomHashMap(Strategy<K> strategy) {
		this(16, 0.75F, strategy);
	}

	public Object2CharOpenCustomHashMap(Map<? extends K, ? extends Character> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Object2CharOpenCustomHashMap(Map<? extends K, ? extends Character> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Object2CharOpenCustomHashMap(Object2CharMap<K> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Object2CharOpenCustomHashMap(Object2CharMap<K> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Object2CharOpenCustomHashMap(K[] k, char[] v, float f, Strategy<K> strategy) {
	...
	public Object2CharOpenCustomHashMap(K[] k, char[] v, Strategy<K> strategy) {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		char[] value = this.value;
		Object2CharOpenCustomHashMap<K>.MapIterator i = new Object2CharOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator
		extends Object2CharOpenCustomHashMap<K>.MapIterator
		implements ObjectIterator<it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>, java.util.Map.Entry<K, Character> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Object2CharOpenCustomHashMap.this.strategy.equals(Object2CharOpenCustomHashMap.this.key[this.index], (K)e.getKey())
					&& Object2CharOpenCustomHashMap.this.value[this.index] == (Character)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>> implements FastEntrySet<K> {
				...
				if (e.getValue() != null && e.getValue() instanceof Character) {
					...
					if (Object2CharOpenCustomHashMap.this.strategy.equals(k, null)) {
						...
						if ((curr = key[pos = HashCommon.mix(Object2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Object2CharOpenCustomHashMap.this.mask]) == null) {
							return false;
						} else if (Object2CharOpenCustomHashMap.this.strategy.equals(k, curr)) {
			...
			if (!(o instanceof java.util.Map.Entry)) {
				...
				if (e.getValue() != null && e.getValue() instanceof Character) {
					...
					if (Object2CharOpenCustomHashMap.this.strategy.equals(k, null)) {
						...
						if ((curr = key[pos = HashCommon.mix(Object2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Object2CharOpenCustomHashMap.this.mask]) == null) {
							return false;
						} else if (Object2CharOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>> consumer) {
			if (Object2CharOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Object2CharOpenCustomHashMap.this.key[Object2CharOpenCustomHashMap.this.n], Object2CharOpenCustomHashMap.this.value[Object2CharOpenCustomHashMap.this.n]
					)
				);
			}
			...
			while (pos-- != 0) {
				if (Object2CharOpenCustomHashMap.this.key[pos] != null) {
					consumer.accept(new BasicEntry(Object2CharOpenCustomHashMap.this.key[pos], Object2CharOpenCustomHashMap.this.value[pos]));
				}
			}
		}
