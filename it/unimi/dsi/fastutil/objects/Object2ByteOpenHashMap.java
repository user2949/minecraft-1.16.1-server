...
public class Object2ByteOpenHashMap<K> extends AbstractObject2ByteMap<K> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		byte[] value = this.value;
		Object2ByteOpenHashMap<K>.MapIterator i = new Object2ByteOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Object2ByteOpenHashMap<K>.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K>> {
	...
	private class FastEntryIterator extends Object2ByteOpenHashMap<K>.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K>> {
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K>> implements FastEntrySet<K> {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K>> consumer) {
			if (Object2ByteOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Object2ByteOpenHashMap.this.key[Object2ByteOpenHashMap.this.n], Object2ByteOpenHashMap.this.value[Object2ByteOpenHashMap.this.n])
				);
			}
