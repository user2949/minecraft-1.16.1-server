...
public class Reference2IntOpenCustomHashMap<K> extends AbstractReference2IntMap<K> implements Serializable, Cloneable, Hash {
	...
	public Reference2IntOpenCustomHashMap(int expected, float f, Strategy<K> strategy) {
	...
	public Reference2IntOpenCustomHashMap(int expected, Strategy<K> strategy) {
		this(expected, 0.75F, strategy);
	}

	public Reference2IntOpenCustomHashMap(Strategy<K> strategy) {
		this(16, 0.75F, strategy);
	}

	public Reference2IntOpenCustomHashMap(Map<? extends K, ? extends Integer> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Reference2IntOpenCustomHashMap(Map<? extends K, ? extends Integer> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Reference2IntOpenCustomHashMap(Reference2IntMap<K> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Reference2IntOpenCustomHashMap(Reference2IntMap<K> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Reference2IntOpenCustomHashMap(K[] k, int[] v, float f, Strategy<K> strategy) {
	...
	public Reference2IntOpenCustomHashMap(K[] k, int[] v, Strategy<K> strategy) {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		int[] value = this.value;
		Reference2IntOpenCustomHashMap<K>.MapIterator i = new Reference2IntOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator
		extends Reference2IntOpenCustomHashMap<K>.MapIterator
		implements ObjectIterator<it.unimi.dsi.fastutil.objects.Reference2IntMap.Entry<K>> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.objects.Reference2IntMap.Entry<K>, java.util.Map.Entry<K, Integer> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Reference2IntOpenCustomHashMap.this.strategy.equals(Reference2IntOpenCustomHashMap.this.key[this.index], (K)e.getKey())
					&& Reference2IntOpenCustomHashMap.this.value[this.index] == (Integer)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Reference2IntMap.Entry<K>> implements FastEntrySet<K> {
		private MapEntrySet() {
		}
				...
				if (e.getValue() != null && e.getValue() instanceof Integer) {
					...
					if (Reference2IntOpenCustomHashMap.this.strategy.equals(k, null)) {
						...
						if ((curr = key[pos = HashCommon.mix(Reference2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2IntOpenCustomHashMap.this.mask]) == null) {
							return false;
						} else if (Reference2IntOpenCustomHashMap.this.strategy.equals(k, curr)) {
			...
			if (!(o instanceof java.util.Map.Entry)) {
				...
				if (e.getValue() != null && e.getValue() instanceof Integer) {
					...
					if (Reference2IntOpenCustomHashMap.this.strategy.equals(k, null)) {
						...
						if ((curr = key[pos = HashCommon.mix(Reference2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2IntOpenCustomHashMap.this.mask]) == null) {
							return false;
						} else if (Reference2IntOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Reference2IntMap.Entry<K>> consumer) {
			if (Reference2IntOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Reference2IntOpenCustomHashMap.this.key[Reference2IntOpenCustomHashMap.this.n],
						Reference2IntOpenCustomHashMap.this.value[Reference2IntOpenCustomHashMap.this.n]
					)
				);
			}
