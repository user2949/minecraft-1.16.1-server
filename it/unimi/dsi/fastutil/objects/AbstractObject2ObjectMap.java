...
public abstract class AbstractObject2ObjectMap<K, V> extends AbstractObject2ObjectFunction<K, V> implements Object2ObjectMap<K, V>, Serializable {
	...
	public boolean containsKey(Object k) {
		ObjectIterator<Entry<K, V>> i = this.object2ObjectEntrySet().iterator();
		...
		return new AbstractObjectSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Entry<K, V>> i = Object2ObjectMaps.fastIterator(AbstractObject2ObjectMap.this);
	...
	public void putAll(Map<? extends K, ? extends V> m) {
		if (m instanceof Object2ObjectMap) {
			ObjectIterator<Entry<K, V>> i = Object2ObjectMaps.fastIterator((Object2ObjectMap<K, V>)m);
	...
	public int hashCode() {
		int h = 0;
		int n = this.size();
		ObjectIterator<Entry<K, V>> i = Object2ObjectMaps.fastIterator(this);
