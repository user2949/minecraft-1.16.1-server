...
public class Object2IntRBTreeMap<K> extends AbstractObject2IntSortedMap<K> implements Serializable, Cloneable {
				...
				while (true) {
					...
					if (!this.dirPath[i - 1]) {
						...
						if (this.nodePath[i - 1].succ() || y.black()) {
							...
							Object2IntRBTreeMap.Entry<K> xx = this.nodePath[i - 1];
							xx.black(false);
							y.black(true);
							xx.left = y.right;
							y.right = xx;
						...
						if (this.nodePath[i - 1].pred() || y.black()) {
							...
							Object2IntRBTreeMap.Entry<K> xxx = this.nodePath[i - 1];
							xxx.black(false);
							y.black(true);
							xxx.right = y.left;
							y.left = xxx;
			...
			if (p.black()) {
				for (; i > 0; i--) {
					...
					if (!this.dirPath[i - 1]) {
						...
						Object2IntRBTreeMap.Entry<K> wx = this.nodePath[i - 1].left;
						if (!wx.black()) {
							wx.black(true);
							this.nodePath[i - 1].black(false);
						...
						if (!wx.pred() && !wx.left.black() || !wx.succ() && !wx.right.black()) {
							if (wx.pred() || wx.left.black()) {
								Object2IntRBTreeMap.Entry<K> y = wx.right;
								y.black(true);
								wx.black(false);
								wx.right = y.left;
								y.left = wx;
	...
	public ObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>> object2IntEntrySet() {
		if (this.entries == null) {
			this.entries = new AbstractObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>>() {
				final Comparator<? super it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>> comparator = (x, y) -> Object2IntRBTreeMap.this.actualComparator
				...
				public ObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>> subSet(
					...
					return (ObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>>)Object2IntRBTreeMap.this.subMap(from.getKey(), to.getKey())
						.object2IntEntrySet();
				}
				...
				public ObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>> headSet(it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K> to) {
					return (ObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>>)Object2IntRBTreeMap.this.headMap(to.getKey()).object2IntEntrySet();
				}
				...
				public ObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>> tailSet(it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K> from) {
					return (ObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>>)Object2IntRBTreeMap.this.tailMap(from.getKey()).object2IntEntrySet();
				}
			};
		}
	...
	private class EntryIterator extends Object2IntRBTreeMap<K>.TreeIterator implements ObjectListIterator<it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>> {
		EntryIterator() {
		}
	...
	private class KeySet extends AbstractObject2IntSortedMap<K>.KeySet {
		private KeySet() {
			super(Object2IntRBTreeMap.this);
		}
	...
	private final class Submap extends AbstractObject2IntSortedMap<K> implements Serializable {
		...
		@Override
		public boolean containsKey(Object k) {
			return this.in((K)k) && Object2IntRBTreeMap.this.containsKey(k);
		}
		...
		public int getInt(Object k) {
			Object2IntRBTreeMap.Entry<K> e;
			return this.in((K)k) && (e = Object2IntRBTreeMap.this.findKey((K)k)) != null ? e.value : this.defRetValue;
		}
		...
		public Object2IntSortedMap<K> headMap(K to) {
			if (this.top) {
				...
				return Object2IntRBTreeMap.this.compare(to, this.to) < 0 ? Object2IntRBTreeMap.this.new Submap(this.from, this.bottom, to, false) : this;
			}
		}
		...
		public Object2IntSortedMap<K> tailMap(K from) {
			if (this.bottom) {
				...
				return Object2IntRBTreeMap.this.compare(from, this.from) > 0 ? Object2IntRBTreeMap.this.new Submap(from, false, this.to, this.top) : this;
			}
		}
		...
		public Object2IntRBTreeMap.Entry<K> firstEntry() {
			if (Object2IntRBTreeMap.this.tree == null) {
				...
				return e != null && (this.top || Object2IntRBTreeMap.this.compare(e.key, this.to) < 0) ? e : null;
			}
		}
		...
		public Object2IntRBTreeMap.Entry<K> lastEntry() {
			if (Object2IntRBTreeMap.this.tree == null) {
				...
				return e != null && (this.bottom || Object2IntRBTreeMap.this.compare(e.key, this.from) >= 0) ? e : null;
			}
		}
		...
		private class SubmapEntryIterator
			extends Object2IntRBTreeMap<K>.Submap.SubmapIterator
