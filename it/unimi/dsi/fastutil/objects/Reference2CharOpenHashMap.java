...
public class Reference2CharOpenHashMap<K> extends AbstractReference2CharMap<K> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		char[] value = this.value;
		Reference2CharOpenHashMap<K>.MapIterator i = new Reference2CharOpenHashMap.MapIterator();
	...
	private class EntryIterator
		extends Reference2CharOpenHashMap<K>.MapIterator
	...
	final class MapEntry implements it.unimi.dsi.fastutil.objects.Reference2CharMap.Entry<K>, java.util.Map.Entry<K, Character> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Reference2CharOpenHashMap.this.key[this.index] == e.getKey() && Reference2CharOpenHashMap.this.value[this.index] == (Character)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Reference2CharMap.Entry<K>> implements FastEntrySet<K> {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Reference2CharMap.Entry<K>> consumer) {
			if (Reference2CharOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Reference2CharOpenHashMap.this.key[Reference2CharOpenHashMap.this.n], Reference2CharOpenHashMap.this.value[Reference2CharOpenHashMap.this.n]
					)
				);
			}
			...
			while (pos-- != 0) {
				if (Reference2CharOpenHashMap.this.key[pos] != null) {
					consumer.accept(new BasicEntry(Reference2CharOpenHashMap.this.key[pos], Reference2CharOpenHashMap.this.value[pos]));
				}
			}
		}
