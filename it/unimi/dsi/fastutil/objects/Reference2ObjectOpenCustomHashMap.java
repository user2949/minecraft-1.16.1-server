...
public class Reference2ObjectOpenCustomHashMap<K, V> extends AbstractReference2ObjectMap<K, V> implements Serializable, Cloneable, Hash {
	...
	public Reference2ObjectOpenCustomHashMap(int expected, float f, Strategy<K> strategy) {
	...
	public Reference2ObjectOpenCustomHashMap(int expected, Strategy<K> strategy) {
		this(expected, 0.75F, strategy);
	}

	public Reference2ObjectOpenCustomHashMap(Strategy<K> strategy) {
		this(16, 0.75F, strategy);
	}

	public Reference2ObjectOpenCustomHashMap(Map<? extends K, ? extends V> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Reference2ObjectOpenCustomHashMap(Map<? extends K, ? extends V> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Reference2ObjectOpenCustomHashMap(Reference2ObjectMap<K, V> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Reference2ObjectOpenCustomHashMap(Reference2ObjectMap<K, V> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Reference2ObjectOpenCustomHashMap(K[] k, V[] v, float f, Strategy<K> strategy) {
	...
	public Reference2ObjectOpenCustomHashMap(K[] k, V[] v, Strategy<K> strategy) {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		V[] value = this.value;
		Reference2ObjectOpenCustomHashMap<K, V>.MapIterator i = new Reference2ObjectOpenCustomHashMap.MapIterator();
	...
	final class MapEntry implements it.unimi.dsi.fastutil.objects.Reference2ObjectMap.Entry<K, V>, java.util.Map.Entry<K, V> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Reference2ObjectOpenCustomHashMap.this.strategy.equals(Reference2ObjectOpenCustomHashMap.this.key[this.index], (K)e.getKey())
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Reference2ObjectMap.Entry<K, V>> implements FastEntrySet<K, V> {
			...
			if (!(o instanceof java.util.Map.Entry)) {
				...
				if (Reference2ObjectOpenCustomHashMap.this.strategy.equals(k, null)) {
					...
					if ((curr = key[pos = HashCommon.mix(Reference2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ObjectOpenCustomHashMap.this.mask]) == null) {
						return false;
					} else if (Reference2ObjectOpenCustomHashMap.this.strategy.equals(k, curr)) {
		...
		public boolean remove(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				if (Reference2ObjectOpenCustomHashMap.this.strategy.equals(k, null)) {
					...
					if ((curr = key[pos = HashCommon.mix(Reference2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ObjectOpenCustomHashMap.this.mask]) == null) {
						return false;
					} else if (Reference2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Reference2ObjectMap.Entry<K, V>> consumer) {
			if (Reference2ObjectOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Reference2ObjectOpenCustomHashMap.this.key[Reference2ObjectOpenCustomHashMap.this.n],
						Reference2ObjectOpenCustomHashMap.this.value[Reference2ObjectOpenCustomHashMap.this.n]
					)
				);
			}
	...
	private class MapIterator {
		...
		private void shiftKeys(int pos) {
			...
			while (true) {
				...
				K curr;
				for (pos = pos + 1 & Reference2ObjectOpenCustomHashMap.this.mask; (curr = key[pos]) != null; pos = pos + 1 & Reference2ObjectOpenCustomHashMap.this.mask) {
