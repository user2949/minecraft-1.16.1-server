...
public class Object2ByteArrayMap<K> extends AbstractObject2ByteMap<K> implements Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K>> implements FastEntrySet<K> {
		private EntrySet() {
		}

		@Override
		public ObjectIterator<it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K>> iterator() {
			return new ObjectIterator<it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K>>() {
				int curr = -1;
				int next = 0;
				...
				public it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K> next() {
					if (!this.hasNext()) {
						...
						return new BasicEntry<>((K)Object2ByteArrayMap.this.key[this.curr = this.next], Object2ByteArrayMap.this.value[this.next++]);
					}
				}
