...
public abstract class AbstractReference2CharMap<K> extends AbstractReference2CharFunction<K> implements Reference2CharMap<K>, Serializable {
	...
	public boolean containsKey(Object k) {
		ObjectIterator<Entry<K>> i = this.reference2CharEntrySet().iterator();
		...
		return new AbstractReferenceSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Entry<K>> i = Reference2CharMaps.fastIterator(AbstractReference2CharMap.this);
	...
	public void putAll(Map<? extends K, ? extends Character> m) {
		if (m instanceof Reference2CharMap) {
			ObjectIterator<Entry<K>> i = Reference2CharMaps.fastIterator((Reference2CharMap<K>)m);
	...
	public int hashCode() {
		int h = 0;
		int n = this.size();
		ObjectIterator<Entry<K>> i = Reference2CharMaps.fastIterator(this);
