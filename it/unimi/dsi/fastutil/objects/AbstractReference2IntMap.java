...
public abstract class AbstractReference2IntMap<K> extends AbstractReference2IntFunction<K> implements Reference2IntMap<K>, Serializable {
	...
	public boolean containsKey(Object k) {
		ObjectIterator<Entry<K>> i = this.reference2IntEntrySet().iterator();
		...
		return new AbstractReferenceSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Entry<K>> i = Reference2IntMaps.fastIterator(AbstractReference2IntMap.this);
	...
	public void putAll(Map<? extends K, ? extends Integer> m) {
		if (m instanceof Reference2IntMap) {
			ObjectIterator<Entry<K>> i = Reference2IntMaps.fastIterator((Reference2IntMap<K>)m);
	...
	public int hashCode() {
		int h = 0;
		int n = this.size();
		ObjectIterator<Entry<K>> i = Reference2IntMaps.fastIterator(this);
