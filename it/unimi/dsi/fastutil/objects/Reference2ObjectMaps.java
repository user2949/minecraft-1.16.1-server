...
import it.unimi.dsi.fastutil.objects.Reference2ObjectFunctions.EmptyFunction;
import it.unimi.dsi.fastutil.objects.Reference2ObjectFunctions.SynchronizedFunction;
import it.unimi.dsi.fastutil.objects.Reference2ObjectFunctions.UnmodifiableFunction;
...
public final class Reference2ObjectMaps {
	...
	public static <K, V> ObjectIterator<Entry<K, V>> fastIterator(Reference2ObjectMap<K, V> map) {
		ObjectSet<Entry<K, V>> entries = map.reference2ObjectEntrySet();
		return entries instanceof FastEntrySet ? ((FastEntrySet)entries).fastIterator() : entries.iterator();
	}

	public static <K, V> void fastForEach(Reference2ObjectMap<K, V> map, Consumer<? super Entry<K, V>> consumer) {
		ObjectSet<Entry<K, V>> entries = map.reference2ObjectEntrySet();
	...
	public static <K, V> ObjectIterable<Entry<K, V>> fastIterable(Reference2ObjectMap<K, V> map) {
		final ObjectSet<Entry<K, V>> entries = map.reference2ObjectEntrySet();
	...
	public static class EmptyMap<K, V> extends EmptyFunction<K, V> implements Reference2ObjectMap<K, V>, Serializable, Cloneable {
	...
	public static class SynchronizedMap<K, V> extends SynchronizedFunction<K, V> implements Reference2ObjectMap<K, V>, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableMap<K, V> extends UnmodifiableFunction<K, V> implements Reference2ObjectMap<K, V>, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Reference2ObjectMap<K, V> map;
		protected transient ObjectSet<Entry<K, V>> entries;
		protected transient ReferenceSet<K> keys;
