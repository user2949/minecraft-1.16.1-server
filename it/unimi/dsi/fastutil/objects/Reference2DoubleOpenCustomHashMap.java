...
public class Reference2DoubleOpenCustomHashMap<K> extends AbstractReference2DoubleMap<K> implements Serializable, Cloneable, Hash {
	...
	public Reference2DoubleOpenCustomHashMap(int expected, float f, Strategy<K> strategy) {
	...
	public Reference2DoubleOpenCustomHashMap(int expected, Strategy<K> strategy) {
		this(expected, 0.75F, strategy);
	}

	public Reference2DoubleOpenCustomHashMap(Strategy<K> strategy) {
		this(16, 0.75F, strategy);
	}

	public Reference2DoubleOpenCustomHashMap(Map<? extends K, ? extends Double> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Reference2DoubleOpenCustomHashMap(Map<? extends K, ? extends Double> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Reference2DoubleOpenCustomHashMap(Reference2DoubleMap<K> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Reference2DoubleOpenCustomHashMap(Reference2DoubleMap<K> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Reference2DoubleOpenCustomHashMap(K[] k, double[] v, float f, Strategy<K> strategy) {
	...
	public Reference2DoubleOpenCustomHashMap(K[] k, double[] v, Strategy<K> strategy) {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		double[] value = this.value;
		Reference2DoubleOpenCustomHashMap<K>.MapIterator i = new Reference2DoubleOpenCustomHashMap.MapIterator();
	...
	final class MapEntry implements it.unimi.dsi.fastutil.objects.Reference2DoubleMap.Entry<K>, java.util.Map.Entry<K, Double> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Reference2DoubleOpenCustomHashMap.this.strategy.equals(Reference2DoubleOpenCustomHashMap.this.key[this.index], (K)e.getKey())
					&& Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits((Double)e.getValue());
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Reference2DoubleMap.Entry<K>> implements FastEntrySet<K> {
				...
				if (e.getValue() != null && e.getValue() instanceof Double) {
					...
					if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(k, null)) {
						return Reference2DoubleOpenCustomHashMap.this.containsNullKey
							&& Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[Reference2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(v);
					} else {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Reference2DoubleMap.Entry<K>> consumer) {
			if (Reference2DoubleOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Reference2DoubleOpenCustomHashMap.this.key[Reference2DoubleOpenCustomHashMap.this.n],
						Reference2DoubleOpenCustomHashMap.this.value[Reference2DoubleOpenCustomHashMap.this.n]
					)
				);
			}
	...
	private class MapIterator {
		...
		private void shiftKeys(int pos) {
			...
			while (true) {
				...
				K curr;
				for (pos = pos + 1 & Reference2DoubleOpenCustomHashMap.this.mask; (curr = key[pos]) != null; pos = pos + 1 & Reference2DoubleOpenCustomHashMap.this.mask) {
