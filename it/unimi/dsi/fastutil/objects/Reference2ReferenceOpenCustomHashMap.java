...
public class Reference2ReferenceOpenCustomHashMap<K, V> extends AbstractReference2ReferenceMap<K, V> implements Serializable, Cloneable, Hash {
	...
	public Reference2ReferenceOpenCustomHashMap(int expected, float f, Strategy<K> strategy) {
	...
	public Reference2ReferenceOpenCustomHashMap(int expected, Strategy<K> strategy) {
		this(expected, 0.75F, strategy);
	}

	public Reference2ReferenceOpenCustomHashMap(Strategy<K> strategy) {
		this(16, 0.75F, strategy);
	}

	public Reference2ReferenceOpenCustomHashMap(Map<? extends K, ? extends V> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Reference2ReferenceOpenCustomHashMap(Map<? extends K, ? extends V> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Reference2ReferenceOpenCustomHashMap(Reference2ReferenceMap<K, V> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Reference2ReferenceOpenCustomHashMap(Reference2ReferenceMap<K, V> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Reference2ReferenceOpenCustomHashMap(K[] k, V[] v, float f, Strategy<K> strategy) {
	...
	public Reference2ReferenceOpenCustomHashMap(K[] k, V[] v, Strategy<K> strategy) {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		V[] value = this.value;
		Reference2ReferenceOpenCustomHashMap<K, V>.MapIterator i = new Reference2ReferenceOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator
		extends Reference2ReferenceOpenCustomHashMap<K, V>.MapIterator
		implements ObjectIterator<it.unimi.dsi.fastutil.objects.Reference2ReferenceMap.Entry<K, V>> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.objects.Reference2ReferenceMap.Entry<K, V>, java.util.Map.Entry<K, V> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Reference2ReferenceOpenCustomHashMap.this.strategy.equals(Reference2ReferenceOpenCustomHashMap.this.key[this.index], (K)e.getKey())
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Reference2ReferenceMap.Entry<K, V>> implements FastEntrySet<K, V> {
		private MapEntrySet() {
		}

		@Override
		public ObjectIterator<it.unimi.dsi.fastutil.objects.Reference2ReferenceMap.Entry<K, V>> iterator() {
			return Reference2ReferenceOpenCustomHashMap.this.new EntryIterator();
		}

		@Override
		public ObjectIterator<it.unimi.dsi.fastutil.objects.Reference2ReferenceMap.Entry<K, V>> fastIterator() {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Reference2ReferenceMap.Entry<K, V>> consumer) {
			if (Reference2ReferenceOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Reference2ReferenceOpenCustomHashMap.this.key[Reference2ReferenceOpenCustomHashMap.this.n],
						Reference2ReferenceOpenCustomHashMap.this.value[Reference2ReferenceOpenCustomHashMap.this.n]
					)
				);
			}
