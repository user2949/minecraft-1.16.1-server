...
public class Object2ByteOpenCustomHashMap<K> extends AbstractObject2ByteMap<K> implements Serializable, Cloneable, Hash {
	...
	public Object2ByteOpenCustomHashMap(int expected, float f, Strategy<K> strategy) {
	...
	public Object2ByteOpenCustomHashMap(int expected, Strategy<K> strategy) {
		this(expected, 0.75F, strategy);
	}

	public Object2ByteOpenCustomHashMap(Strategy<K> strategy) {
		this(16, 0.75F, strategy);
	}

	public Object2ByteOpenCustomHashMap(Map<? extends K, ? extends Byte> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Object2ByteOpenCustomHashMap(Map<? extends K, ? extends Byte> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Object2ByteOpenCustomHashMap(Object2ByteMap<K> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Object2ByteOpenCustomHashMap(Object2ByteMap<K> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Object2ByteOpenCustomHashMap(K[] k, byte[] v, float f, Strategy<K> strategy) {
	...
	public Object2ByteOpenCustomHashMap(K[] k, byte[] v, Strategy<K> strategy) {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		byte[] value = this.value;
		Object2ByteOpenCustomHashMap<K>.MapIterator i = new Object2ByteOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator
		extends Object2ByteOpenCustomHashMap<K>.MapIterator
		implements ObjectIterator<it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K>> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K>, java.util.Map.Entry<K, Byte> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Object2ByteOpenCustomHashMap.this.strategy.equals(Object2ByteOpenCustomHashMap.this.key[this.index], (K)e.getKey())
					&& Object2ByteOpenCustomHashMap.this.value[this.index] == (Byte)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K>> implements FastEntrySet<K> {
		private MapEntrySet() {
		}

		@Override
		public ObjectIterator<it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K>> iterator() {
			return Object2ByteOpenCustomHashMap.this.new EntryIterator();
		}

		@Override
		public ObjectIterator<it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K>> fastIterator() {
				...
				if (e.getValue() != null && e.getValue() instanceof Byte) {
					...
					if (Object2ByteOpenCustomHashMap.this.strategy.equals(k, null)) {
						...
						if ((curr = key[pos = HashCommon.mix(Object2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ByteOpenCustomHashMap.this.mask]) == null) {
							return false;
						} else if (Object2ByteOpenCustomHashMap.this.strategy.equals(k, curr)) {
			...
			if (!(o instanceof java.util.Map.Entry)) {
				...
				if (e.getValue() != null && e.getValue() instanceof Byte) {
					...
					if (Object2ByteOpenCustomHashMap.this.strategy.equals(k, null)) {
						...
						if ((curr = key[pos = HashCommon.mix(Object2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ByteOpenCustomHashMap.this.mask]) == null) {
							return false;
						} else if (Object2ByteOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Object2ByteMap.Entry<K>> consumer) {
			if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Object2ByteOpenCustomHashMap.this.key[Object2ByteOpenCustomHashMap.this.n], Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n]
					)
				);
			}
