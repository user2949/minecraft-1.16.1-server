...
public abstract class AbstractReference2ByteMap<K> extends AbstractReference2ByteFunction<K> implements Reference2ByteMap<K>, Serializable {
	...
	public boolean containsKey(Object k) {
		ObjectIterator<Entry<K>> i = this.reference2ByteEntrySet().iterator();
		...
		return new AbstractReferenceSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Entry<K>> i = Reference2ByteMaps.fastIterator(AbstractReference2ByteMap.this);
	...
	public void putAll(Map<? extends K, ? extends Byte> m) {
		if (m instanceof Reference2ByteMap) {
			ObjectIterator<Entry<K>> i = Reference2ByteMaps.fastIterator((Reference2ByteMap<K>)m);
	...
	public int hashCode() {
		int h = 0;
		int n = this.size();
		ObjectIterator<Entry<K>> i = Reference2ByteMaps.fastIterator(this);
