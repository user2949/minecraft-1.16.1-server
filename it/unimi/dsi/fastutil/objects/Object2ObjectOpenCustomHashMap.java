...
public class Object2ObjectOpenCustomHashMap<K, V> extends AbstractObject2ObjectMap<K, V> implements Serializable, Cloneable, Hash {
	...
	public Object2ObjectOpenCustomHashMap(int expected, float f, Strategy<K> strategy) {
	...
	public Object2ObjectOpenCustomHashMap(int expected, Strategy<K> strategy) {
		this(expected, 0.75F, strategy);
	}

	public Object2ObjectOpenCustomHashMap(Strategy<K> strategy) {
		this(16, 0.75F, strategy);
	}

	public Object2ObjectOpenCustomHashMap(Map<? extends K, ? extends V> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Object2ObjectOpenCustomHashMap(Map<? extends K, ? extends V> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Object2ObjectOpenCustomHashMap(Object2ObjectMap<K, V> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Object2ObjectOpenCustomHashMap(Object2ObjectMap<K, V> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Object2ObjectOpenCustomHashMap(K[] k, V[] v, float f, Strategy<K> strategy) {
	...
	public Object2ObjectOpenCustomHashMap(K[] k, V[] v, Strategy<K> strategy) {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		V[] value = this.value;
		Object2ObjectOpenCustomHashMap<K, V>.MapIterator i = new Object2ObjectOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator
		extends Object2ObjectOpenCustomHashMap<K, V>.MapIterator
		implements ObjectIterator<it.unimi.dsi.fastutil.objects.Object2ObjectMap.Entry<K, V>> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.objects.Object2ObjectMap.Entry<K, V>, java.util.Map.Entry<K, V> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Object2ObjectOpenCustomHashMap.this.strategy.equals(Object2ObjectOpenCustomHashMap.this.key[this.index], (K)e.getKey())
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Object2ObjectMap.Entry<K, V>> implements FastEntrySet<K, V> {
		private MapEntrySet() {
		}
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Object2ObjectMap.Entry<K, V>> consumer) {
			if (Object2ObjectOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Object2ObjectOpenCustomHashMap.this.key[Object2ObjectOpenCustomHashMap.this.n],
						Object2ObjectOpenCustomHashMap.this.value[Object2ObjectOpenCustomHashMap.this.n]
					)
				);
			}
