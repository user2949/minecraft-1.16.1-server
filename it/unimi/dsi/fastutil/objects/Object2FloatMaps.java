...
import it.unimi.dsi.fastutil.objects.Object2FloatFunctions.EmptyFunction;
import it.unimi.dsi.fastutil.objects.Object2FloatFunctions.SynchronizedFunction;
import it.unimi.dsi.fastutil.objects.Object2FloatFunctions.UnmodifiableFunction;
...
public final class Object2FloatMaps {
	...
	public static <K> ObjectIterator<Entry<K>> fastIterator(Object2FloatMap<K> map) {
		ObjectSet<Entry<K>> entries = map.object2FloatEntrySet();
		return entries instanceof FastEntrySet ? ((FastEntrySet)entries).fastIterator() : entries.iterator();
	}

	public static <K> void fastForEach(Object2FloatMap<K> map, Consumer<? super Entry<K>> consumer) {
		ObjectSet<Entry<K>> entries = map.object2FloatEntrySet();
	...
	public static <K> ObjectIterable<Entry<K>> fastIterable(Object2FloatMap<K> map) {
		final ObjectSet<Entry<K>> entries = map.object2FloatEntrySet();
	...
	public static class EmptyMap<K> extends EmptyFunction<K> implements Object2FloatMap<K>, Serializable, Cloneable {
	...
	public static class SynchronizedMap<K> extends SynchronizedFunction<K> implements Object2FloatMap<K>, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableMap<K> extends UnmodifiableFunction<K> implements Object2FloatMap<K>, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Object2FloatMap<K> map;
		protected transient ObjectSet<Entry<K>> entries;
		protected transient ObjectSet<K> keys;
