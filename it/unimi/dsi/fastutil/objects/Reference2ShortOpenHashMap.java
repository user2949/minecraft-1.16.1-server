...
public class Reference2ShortOpenHashMap<K> extends AbstractReference2ShortMap<K> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		short[] value = this.value;
		Reference2ShortOpenHashMap<K>.MapIterator i = new Reference2ShortOpenHashMap.MapIterator();
	...
	private class EntryIterator
		extends Reference2ShortOpenHashMap<K>.MapIterator
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Reference2ShortMap.Entry<K>> implements FastEntrySet<K> {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Reference2ShortMap.Entry<K>> consumer) {
			if (Reference2ShortOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Reference2ShortOpenHashMap.this.key[Reference2ShortOpenHashMap.this.n], Reference2ShortOpenHashMap.this.value[Reference2ShortOpenHashMap.this.n]
					)
				);
			}
