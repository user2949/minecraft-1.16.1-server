...
import it.unimi.dsi.fastutil.objects.Reference2CharFunctions.EmptyFunction;
import it.unimi.dsi.fastutil.objects.Reference2CharFunctions.SynchronizedFunction;
import it.unimi.dsi.fastutil.objects.Reference2CharFunctions.UnmodifiableFunction;
...
public final class Reference2CharMaps {
	...
	public static <K> ObjectIterator<Entry<K>> fastIterator(Reference2CharMap<K> map) {
		ObjectSet<Entry<K>> entries = map.reference2CharEntrySet();
		return entries instanceof FastEntrySet ? ((FastEntrySet)entries).fastIterator() : entries.iterator();
	}

	public static <K> void fastForEach(Reference2CharMap<K> map, Consumer<? super Entry<K>> consumer) {
		ObjectSet<Entry<K>> entries = map.reference2CharEntrySet();
	...
	public static <K> ObjectIterable<Entry<K>> fastIterable(Reference2CharMap<K> map) {
		final ObjectSet<Entry<K>> entries = map.reference2CharEntrySet();
	...
	public static class EmptyMap<K> extends EmptyFunction<K> implements Reference2CharMap<K>, Serializable, Cloneable {
	...
	public static class SynchronizedMap<K> extends SynchronizedFunction<K> implements Reference2CharMap<K>, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableMap<K> extends UnmodifiableFunction<K> implements Reference2CharMap<K>, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Reference2CharMap<K> map;
		protected transient ObjectSet<Entry<K>> entries;
		protected transient ReferenceSet<K> keys;
