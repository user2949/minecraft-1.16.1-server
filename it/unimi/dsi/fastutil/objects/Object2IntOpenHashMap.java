...
public class Object2IntOpenHashMap<K> extends AbstractObject2IntMap<K> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		int[] value = this.value;
		Object2IntOpenHashMap<K>.MapIterator i = new Object2IntOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Object2IntOpenHashMap<K>.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>> {
	...
	private class FastEntryIterator extends Object2IntOpenHashMap<K>.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>> {
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>> implements FastEntrySet<K> {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<K>> consumer) {
			if (Object2IntOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Object2IntOpenHashMap.this.key[Object2IntOpenHashMap.this.n], Object2IntOpenHashMap.this.value[Object2IntOpenHashMap.this.n])
				);
			}
