...
public final class ObjectArrays {
	...
	public static final Strategy HASH_STRATEGY = new ObjectArrays.ArrayHashStrategy();
	...
	public static <K> void mergeSort(K[] a, int from, int to) {
		mergeSort(a, from, to, (K[])((Object[])a.clone()));
	}
	...
	public static <K> void mergeSort(K[] a, int from, int to, Comparator<K> comp) {
		mergeSort(a, from, to, comp, (K[])((Object[])a.clone()));
	}
	...
	private static final class ArrayHashStrategy<K> implements Strategy<K[]>, Serializable {
				...
				while (true) {
					...
					while (b > c || (comparison = ((Comparable)x[b]).compareTo(v)) > 0) {
						...
						if (b > c) {
							...
							comparison = d - c;
							if (s > 1 && comparison > 1) {
								invokeAll(new ObjectArrays.ForkJoinQuickSort(x, this.from, this.from + s), new ObjectArrays.ForkJoinQuickSort(x, this.to - comparison, this.to));
							} else if (s > 1) {
				...
				while (true) {
					...
					while (b > c || (comparison = (t = ((Comparable)x[b]).compareTo(v)) == 0 ? ((Comparable)y[b]).compareTo(w) : t) > 0) {
						...
						if (b > c) {
							...
							comparison = d - c;
							if (s > 1 && comparison > 1) {
								invokeAll(new ObjectArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s), new ObjectArrays.ForkJoinQuickSort2(x, y, this.to - comparison, this.to));
							} else if (s > 1) {
