...
public class Reference2FloatOpenCustomHashMap<K> extends AbstractReference2FloatMap<K> implements Serializable, Cloneable, Hash {
	...
	public Reference2FloatOpenCustomHashMap(int expected, float f, Strategy<K> strategy) {
	...
	public Reference2FloatOpenCustomHashMap(int expected, Strategy<K> strategy) {
		this(expected, 0.75F, strategy);
	}

	public Reference2FloatOpenCustomHashMap(Strategy<K> strategy) {
		this(16, 0.75F, strategy);
	}

	public Reference2FloatOpenCustomHashMap(Map<? extends K, ? extends Float> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Reference2FloatOpenCustomHashMap(Map<? extends K, ? extends Float> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Reference2FloatOpenCustomHashMap(Reference2FloatMap<K> m, float f, Strategy<K> strategy) {
		this(m.size(), f, strategy);
		this.putAll(m);
	}

	public Reference2FloatOpenCustomHashMap(Reference2FloatMap<K> m, Strategy<K> strategy) {
		this(m, 0.75F, strategy);
	}

	public Reference2FloatOpenCustomHashMap(K[] k, float[] v, float f, Strategy<K> strategy) {
	...
	public Reference2FloatOpenCustomHashMap(K[] k, float[] v, Strategy<K> strategy) {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		float[] value = this.value;
		Reference2FloatOpenCustomHashMap<K>.MapIterator i = new Reference2FloatOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator
		extends Reference2FloatOpenCustomHashMap<K>.MapIterator
	...
	final class MapEntry implements it.unimi.dsi.fastutil.objects.Reference2FloatMap.Entry<K>, java.util.Map.Entry<K, Float> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Reference2FloatOpenCustomHashMap.this.strategy.equals(Reference2FloatOpenCustomHashMap.this.key[this.index], (K)e.getKey())
					&& Float.floatToIntBits(Reference2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((Float)e.getValue());
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Reference2FloatMap.Entry<K>> implements FastEntrySet<K> {
				...
				if (e.getValue() != null && e.getValue() instanceof Float) {
					...
					if (Reference2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
						...
						if ((curr = key[pos = HashCommon.mix(Reference2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2FloatOpenCustomHashMap.this.mask]) == null) {
							return false;
						} else if (Reference2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
			...
			if (!(o instanceof java.util.Map.Entry)) {
				...
				if (e.getValue() != null && e.getValue() instanceof Float) {
					...
					if (Reference2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
						...
						if ((curr = key[pos = HashCommon.mix(Reference2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2FloatOpenCustomHashMap.this.mask]) == null) {
							return false;
						} else if (Reference2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Reference2FloatMap.Entry<K>> consumer) {
			if (Reference2FloatOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Reference2FloatOpenCustomHashMap.this.key[Reference2FloatOpenCustomHashMap.this.n],
						Reference2FloatOpenCustomHashMap.this.value[Reference2FloatOpenCustomHashMap.this.n]
					)
				);
			}
	...
	private class MapIterator {
		...
		private void shiftKeys(int pos) {
			...
			while (true) {
				...
				K curr;
				for (pos = pos + 1 & Reference2FloatOpenCustomHashMap.this.mask; (curr = key[pos]) != null; pos = pos + 1 & Reference2FloatOpenCustomHashMap.this.mask) {
