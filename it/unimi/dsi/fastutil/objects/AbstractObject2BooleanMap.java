...
public abstract class AbstractObject2BooleanMap<K> extends AbstractObject2BooleanFunction<K> implements Object2BooleanMap<K>, Serializable {
	...
	public boolean containsKey(Object k) {
		ObjectIterator<Entry<K>> i = this.object2BooleanEntrySet().iterator();
		...
		return new AbstractObjectSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Entry<K>> i = Object2BooleanMaps.fastIterator(AbstractObject2BooleanMap.this);
	...
	public void putAll(Map<? extends K, ? extends Boolean> m) {
		if (m instanceof Object2BooleanMap) {
			ObjectIterator<Entry<K>> i = Object2BooleanMaps.fastIterator((Object2BooleanMap<K>)m);
	...
	public int hashCode() {
		int h = 0;
		int n = this.size();
		ObjectIterator<Entry<K>> i = Object2BooleanMaps.fastIterator(this);
