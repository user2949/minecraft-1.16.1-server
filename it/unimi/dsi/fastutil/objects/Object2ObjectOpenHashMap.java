...
public class Object2ObjectOpenHashMap<K, V> extends AbstractObject2ObjectMap<K, V> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		V[] value = this.value;
		Object2ObjectOpenHashMap<K, V>.MapIterator i = new Object2ObjectOpenHashMap.MapIterator();
	...
	private class EntryIterator
		extends Object2ObjectOpenHashMap<K, V>.MapIterator
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Object2ObjectMap.Entry<K, V>> implements FastEntrySet<K, V> {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Object2ObjectMap.Entry<K, V>> consumer) {
			if (Object2ObjectOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Object2ObjectOpenHashMap.this.key[Object2ObjectOpenHashMap.this.n], Object2ObjectOpenHashMap.this.value[Object2ObjectOpenHashMap.this.n])
				);
			}
