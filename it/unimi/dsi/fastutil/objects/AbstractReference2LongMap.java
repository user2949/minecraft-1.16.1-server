...
public abstract class AbstractReference2LongMap<K> extends AbstractReference2LongFunction<K> implements Reference2LongMap<K>, Serializable {
	...
	public boolean containsKey(Object k) {
		ObjectIterator<Entry<K>> i = this.reference2LongEntrySet().iterator();
		...
		return new AbstractReferenceSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Entry<K>> i = Reference2LongMaps.fastIterator(AbstractReference2LongMap.this);
	...
	public void putAll(Map<? extends K, ? extends Long> m) {
		if (m instanceof Reference2LongMap) {
			ObjectIterator<Entry<K>> i = Reference2LongMaps.fastIterator((Reference2LongMap<K>)m);
	...
	public int hashCode() {
		int h = 0;
		int n = this.size();
		ObjectIterator<Entry<K>> i = Reference2LongMaps.fastIterator(this);
