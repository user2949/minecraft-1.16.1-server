...
public class Reference2ReferenceOpenHashMap<K, V> extends AbstractReference2ReferenceMap<K, V> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		K[] key = this.key;
		V[] value = this.value;
		Reference2ReferenceOpenHashMap<K, V>.MapIterator i = new Reference2ReferenceOpenHashMap.MapIterator();
	...
	final class MapEntry implements it.unimi.dsi.fastutil.objects.Reference2ReferenceMap.Entry<K, V>, java.util.Map.Entry<K, V> {
		...
		public int hashCode() {
			return System.identityHashCode(Reference2ReferenceOpenHashMap.this.key[this.index])
				^ (Reference2ReferenceOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Reference2ReferenceOpenHashMap.this.value[this.index]));
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.objects.Reference2ReferenceMap.Entry<K, V>> implements FastEntrySet<K, V> {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.objects.Reference2ReferenceMap.Entry<K, V>> consumer) {
			if (Reference2ReferenceOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Reference2ReferenceOpenHashMap.this.key[Reference2ReferenceOpenHashMap.this.n],
						Reference2ReferenceOpenHashMap.this.value[Reference2ReferenceOpenHashMap.this.n]
					)
				);
			}
