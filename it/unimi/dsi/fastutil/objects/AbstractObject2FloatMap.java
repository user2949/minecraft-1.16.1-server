...
public abstract class AbstractObject2FloatMap<K> extends AbstractObject2FloatFunction<K> implements Object2FloatMap<K>, Serializable {
	...
	public boolean containsKey(Object k) {
		ObjectIterator<Entry<K>> i = this.object2FloatEntrySet().iterator();
		...
		return new AbstractObjectSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Entry<K>> i = Object2FloatMaps.fastIterator(AbstractObject2FloatMap.this);
	...
	public void putAll(Map<? extends K, ? extends Float> m) {
		if (m instanceof Object2FloatMap) {
			ObjectIterator<Entry<K>> i = Object2FloatMaps.fastIterator((Object2FloatMap<K>)m);
	...
	public int hashCode() {
		int h = 0;
		int n = this.size();
		ObjectIterator<Entry<K>> i = Object2FloatMaps.fastIterator(this);
