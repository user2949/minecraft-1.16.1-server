...
public class Object2CharRBTreeMap<K> extends AbstractObject2CharSortedMap<K> implements Serializable, Cloneable {
				...
				while (true) {
					...
					if (!this.dirPath[i - 1]) {
						...
						if (this.nodePath[i - 1].succ() || y.black()) {
							...
							Object2CharRBTreeMap.Entry<K> xx = this.nodePath[i - 1];
							xx.black(false);
							y.black(true);
							xx.left = y.right;
							y.right = xx;
						...
						if (this.nodePath[i - 1].pred() || y.black()) {
							...
							Object2CharRBTreeMap.Entry<K> xxx = this.nodePath[i - 1];
							xxx.black(false);
							y.black(true);
							xxx.right = y.left;
							y.left = xxx;
			...
			if (p.black()) {
				for (; i > 0; i--) {
					...
					if (!this.dirPath[i - 1]) {
						...
						Object2CharRBTreeMap.Entry<K> wx = this.nodePath[i - 1].left;
						if (!wx.black()) {
							wx.black(true);
							this.nodePath[i - 1].black(false);
						...
						if (!wx.pred() && !wx.left.black() || !wx.succ() && !wx.right.black()) {
							if (wx.pred() || wx.left.black()) {
								Object2CharRBTreeMap.Entry<K> y = wx.right;
								y.black(true);
								wx.black(false);
								wx.right = y.left;
								y.left = wx;
	...
	public ObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>> object2CharEntrySet() {
		if (this.entries == null) {
			this.entries = new AbstractObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>>() {
				final Comparator<? super it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>> comparator = (x, y) -> Object2CharRBTreeMap.this.actualComparator
				...
				public ObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>> subSet(
					...
					return (ObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>>)Object2CharRBTreeMap.this.subMap(from.getKey(), to.getKey())
						.object2CharEntrySet();
				}
				...
				public ObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>> headSet(it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K> to) {
					return (ObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>>)Object2CharRBTreeMap.this.headMap(to.getKey()).object2CharEntrySet();
				}
				...
				public ObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>> tailSet(it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K> from) {
					return (ObjectSortedSet<it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>>)Object2CharRBTreeMap.this.tailMap(from.getKey()).object2CharEntrySet();
				}
			};
		}
	...
	private class EntryIterator extends Object2CharRBTreeMap<K>.TreeIterator implements ObjectListIterator<it.unimi.dsi.fastutil.objects.Object2CharMap.Entry<K>> {
		EntryIterator() {
		}
	...
	private final class Submap extends AbstractObject2CharSortedMap<K> implements Serializable {
		...
		@Override
		public boolean containsKey(Object k) {
			return this.in((K)k) && Object2CharRBTreeMap.this.containsKey(k);
		}
		...
		public char getChar(Object k) {
			Object2CharRBTreeMap.Entry<K> e;
			return this.in((K)k) && (e = Object2CharRBTreeMap.this.findKey((K)k)) != null ? e.value : this.defRetValue;
		}
		...
		public Object2CharSortedMap<K> headMap(K to) {
			if (this.top) {
				...
				return Object2CharRBTreeMap.this.compare(to, this.to) < 0 ? Object2CharRBTreeMap.this.new Submap(this.from, this.bottom, to, false) : this;
			}
		}
		...
		public Object2CharSortedMap<K> tailMap(K from) {
			if (this.bottom) {
				...
				return Object2CharRBTreeMap.this.compare(from, this.from) > 0 ? Object2CharRBTreeMap.this.new Submap(from, false, this.to, this.top) : this;
			}
		}
		...
		public Object2CharRBTreeMap.Entry<K> firstEntry() {
			if (Object2CharRBTreeMap.this.tree == null) {
				...
				return e != null && (this.top || Object2CharRBTreeMap.this.compare(e.key, this.to) < 0) ? e : null;
			}
		}
		...
		public Object2CharRBTreeMap.Entry<K> lastEntry() {
			if (Object2CharRBTreeMap.this.tree == null) {
				...
				return e != null && (this.bottom || Object2CharRBTreeMap.this.compare(e.key, this.from) >= 0) ? e : null;
			}
		}
