...
import it.unimi.dsi.fastutil.objects.Reference2LongFunctions.EmptyFunction;
import it.unimi.dsi.fastutil.objects.Reference2LongFunctions.SynchronizedFunction;
import it.unimi.dsi.fastutil.objects.Reference2LongFunctions.UnmodifiableFunction;
...
public final class Reference2LongMaps {
	...
	public static <K> ObjectIterator<Entry<K>> fastIterator(Reference2LongMap<K> map) {
		ObjectSet<Entry<K>> entries = map.reference2LongEntrySet();
		return entries instanceof FastEntrySet ? ((FastEntrySet)entries).fastIterator() : entries.iterator();
	}

	public static <K> void fastForEach(Reference2LongMap<K> map, Consumer<? super Entry<K>> consumer) {
		ObjectSet<Entry<K>> entries = map.reference2LongEntrySet();
	...
	public static <K> ObjectIterable<Entry<K>> fastIterable(Reference2LongMap<K> map) {
		final ObjectSet<Entry<K>> entries = map.reference2LongEntrySet();
	...
	public static class EmptyMap<K> extends EmptyFunction<K> implements Reference2LongMap<K>, Serializable, Cloneable {
	...
	public static class SynchronizedMap<K> extends SynchronizedFunction<K> implements Reference2LongMap<K>, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableMap<K> extends UnmodifiableFunction<K> implements Reference2LongMap<K>, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Reference2LongMap<K> map;
		protected transient ObjectSet<Entry<K>> entries;
		protected transient ReferenceSet<K> keys;
