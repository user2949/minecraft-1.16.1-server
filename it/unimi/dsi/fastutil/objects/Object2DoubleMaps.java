...
import it.unimi.dsi.fastutil.objects.Object2DoubleFunctions.EmptyFunction;
import it.unimi.dsi.fastutil.objects.Object2DoubleFunctions.SynchronizedFunction;
import it.unimi.dsi.fastutil.objects.Object2DoubleFunctions.UnmodifiableFunction;
...
public final class Object2DoubleMaps {
	...
	public static <K> ObjectIterator<Entry<K>> fastIterator(Object2DoubleMap<K> map) {
		ObjectSet<Entry<K>> entries = map.object2DoubleEntrySet();
		return entries instanceof FastEntrySet ? ((FastEntrySet)entries).fastIterator() : entries.iterator();
	}

	public static <K> void fastForEach(Object2DoubleMap<K> map, Consumer<? super Entry<K>> consumer) {
		ObjectSet<Entry<K>> entries = map.object2DoubleEntrySet();
	...
	public static <K> ObjectIterable<Entry<K>> fastIterable(Object2DoubleMap<K> map) {
		final ObjectSet<Entry<K>> entries = map.object2DoubleEntrySet();
	...
	public static class EmptyMap<K> extends EmptyFunction<K> implements Object2DoubleMap<K>, Serializable, Cloneable {
	...
	public static class SynchronizedMap<K> extends SynchronizedFunction<K> implements Object2DoubleMap<K>, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableMap<K> extends UnmodifiableFunction<K> implements Object2DoubleMap<K>, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Object2DoubleMap<K> map;
		protected transient ObjectSet<Entry<K>> entries;
		protected transient ObjectSet<K> keys;
