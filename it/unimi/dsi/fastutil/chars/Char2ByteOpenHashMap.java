...
public class Char2ByteOpenHashMap extends AbstractChar2ByteMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		char[] key = this.key;
		byte[] value = this.value;
		Char2ByteOpenHashMap.MapIterator i = new Char2ByteOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Char2ByteOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.chars.Char2ByteMap.Entry> {
	...
	private class FastEntryIterator extends Char2ByteOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.chars.Char2ByteMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.chars.Char2ByteMap.Entry, java.util.Map.Entry<Character, Byte> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Char2ByteOpenHashMap.this.key[this.index] == (Character)e.getKey() && Char2ByteOpenHashMap.this.value[this.index] == (Byte)e.getValue();
			}
		}
