...
public class Char2IntOpenCustomHashMap extends AbstractChar2IntMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		char[] key = this.key;
		int[] value = this.value;
		Char2IntOpenCustomHashMap.MapIterator i = new Char2IntOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Char2IntOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.chars.Char2IntMap.Entry> {
	...
	private class FastEntryIterator extends Char2IntOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.chars.Char2IntMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.chars.Char2IntMap.Entry, java.util.Map.Entry<Character, Integer> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Char2IntOpenCustomHashMap.this.strategy.equals(Char2IntOpenCustomHashMap.this.key[this.index], (Character)e.getKey())
					&& Char2IntOpenCustomHashMap.this.value[this.index] == (Integer)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.chars.Char2IntMap.Entry> implements FastEntrySet {
				...
				if (e.getKey() == null || !(e.getKey() instanceof Character)) {
					...
					if (Char2IntOpenCustomHashMap.this.strategy.equals(k, '\u0000')) {
						...
						if ((curr = key[pos = HashCommon.mix(Char2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Char2IntOpenCustomHashMap.this.mask]) == 0) {
							return false;
						} else if (Char2IntOpenCustomHashMap.this.strategy.equals(k, curr)) {
				...
				if (e.getKey() != null && e.getKey() instanceof Character) {
					if (e.getValue() != null && e.getValue() instanceof Integer) {
						...
						if (Char2IntOpenCustomHashMap.this.strategy.equals(k, '\u0000')) {
							...
							if ((curr = key[pos = HashCommon.mix(Char2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Char2IntOpenCustomHashMap.this.mask]) == 0) {
								return false;
							} else if (Char2IntOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.chars.Char2IntMap.Entry> consumer) {
			if (Char2IntOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Char2IntOpenCustomHashMap.this.key[Char2IntOpenCustomHashMap.this.n], Char2IntOpenCustomHashMap.this.value[Char2IntOpenCustomHashMap.this.n]
					)
				);
			}
