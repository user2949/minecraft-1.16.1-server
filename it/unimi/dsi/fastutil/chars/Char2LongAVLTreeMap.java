...
public class Char2LongAVLTreeMap extends AbstractChar2LongSortedMap implements Serializable, Cloneable {
		...
		if (this.tree == null) {
			...
			while (q != null) {
				...
				if (!dir) {
					...
					if (y.balance() == -2) {
						Char2LongAVLTreeMap.Entry xx = y.left;
						...
						if (xx.balance() == 1) {
							...
							Char2LongAVLTreeMap.Entry wx = xx.right;
							xx.right = wx.left;
							wx.left = xx;
							y.left = wx.right;
							wx.right = y;
	...
	public ObjectSortedSet<it.unimi.dsi.fastutil.chars.Char2LongMap.Entry> char2LongEntrySet() {
		if (this.entries == null) {
			this.entries = new AbstractObjectSortedSet<it.unimi.dsi.fastutil.chars.Char2LongMap.Entry>() {
				final Comparator<? super it.unimi.dsi.fastutil.chars.Char2LongMap.Entry> comparator = (x, y) -> Char2LongAVLTreeMap.this.actualComparator
	...
	private class EntryIterator extends Char2LongAVLTreeMap.TreeIterator implements ObjectListIterator<it.unimi.dsi.fastutil.chars.Char2LongMap.Entry> {
		EntryIterator() {
		}
	...
	private class KeySet extends it.unimi.dsi.fastutil.chars.AbstractChar2LongSortedMap.KeySet {
		private KeySet() {
			super(Char2LongAVLTreeMap.this);
		}
	...
	private final class Submap extends AbstractChar2LongSortedMap implements Serializable {
		...
		public long get(char k) {
			...
			return this.in(k) && (e = Char2LongAVLTreeMap.this.findKey(k)) != null ? e.value : this.defRetValue;
		}
