...
public class Char2ReferenceOpenHashMap<V> extends AbstractChar2ReferenceMap<V> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		char[] key = this.key;
		V[] value = this.value;
		Char2ReferenceOpenHashMap<V>.MapIterator i = new Char2ReferenceOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Char2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.chars.Char2ReferenceMap.Entry<V>> {
	...
	private class FastEntryIterator
		extends Char2ReferenceOpenHashMap<V>.MapIterator
	...
	final class MapEntry implements it.unimi.dsi.fastutil.chars.Char2ReferenceMap.Entry<V>, java.util.Map.Entry<Character, V> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Char2ReferenceOpenHashMap.this.key[this.index] == (Character)e.getKey() && Char2ReferenceOpenHashMap.this.value[this.index] == e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.chars.Char2ReferenceMap.Entry<V>> implements FastEntrySet<V> {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.chars.Char2ReferenceMap.Entry<V>> consumer) {
			if (Char2ReferenceOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Char2ReferenceOpenHashMap.this.key[Char2ReferenceOpenHashMap.this.n], Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.n]
					)
				);
			}
