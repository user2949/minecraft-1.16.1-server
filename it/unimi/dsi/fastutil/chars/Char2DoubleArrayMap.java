...
public class Char2DoubleArrayMap extends AbstractChar2DoubleMap implements Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.chars.Char2DoubleMap.Entry> implements FastEntrySet {
		private EntrySet() {
		}

		@Override
		public ObjectIterator<it.unimi.dsi.fastutil.chars.Char2DoubleMap.Entry> iterator() {
			return new ObjectIterator<it.unimi.dsi.fastutil.chars.Char2DoubleMap.Entry>() {
				int curr = -1;
				int next = 0;
				...
				public it.unimi.dsi.fastutil.chars.Char2DoubleMap.Entry next() {
					if (!this.hasNext()) {
						...
						return new BasicEntry(Char2DoubleArrayMap.this.key[this.curr = this.next], Char2DoubleArrayMap.this.value[this.next++]);
					}
				}
