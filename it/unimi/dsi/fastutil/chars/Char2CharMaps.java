...
import it.unimi.dsi.fastutil.chars.Char2CharFunctions.EmptyFunction;
import it.unimi.dsi.fastutil.chars.Char2CharFunctions.SynchronizedFunction;
import it.unimi.dsi.fastutil.chars.Char2CharFunctions.UnmodifiableFunction;
...
public final class Char2CharMaps {
	...
	public static ObjectIterator<Entry> fastIterator(Char2CharMap map) {
		ObjectSet<Entry> entries = map.char2CharEntrySet();
		return entries instanceof FastEntrySet ? ((FastEntrySet)entries).fastIterator() : entries.iterator();
	}

	public static void fastForEach(Char2CharMap map, Consumer<? super Entry> consumer) {
		ObjectSet<Entry> entries = map.char2CharEntrySet();
	...
	public static ObjectIterable<Entry> fastIterable(Char2CharMap map) {
		final ObjectSet<Entry> entries = map.char2CharEntrySet();
	...
	public static class EmptyMap extends EmptyFunction implements Char2CharMap, Serializable, Cloneable {
	...
	public static class Singleton extends Char2CharFunctions.Singleton implements Char2CharMap, Serializable, Cloneable {
		...
		@Deprecated
		@Override
		public ObjectSet<java.util.Map.Entry<Character, Character>> entrySet() {
	...
	public static class SynchronizedMap extends SynchronizedFunction implements Char2CharMap, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableMap extends UnmodifiableFunction implements Char2CharMap, Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Char2CharMap map;
		protected transient ObjectSet<Entry> entries;
		protected transient CharSet keys;
