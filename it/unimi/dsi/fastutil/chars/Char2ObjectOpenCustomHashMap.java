...
public class Char2ObjectOpenCustomHashMap<V> extends AbstractChar2ObjectMap<V> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		char[] key = this.key;
		V[] value = this.value;
		Char2ObjectOpenCustomHashMap<V>.MapIterator i = new Char2ObjectOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Char2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.chars.Char2ObjectMap.Entry<V>> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.chars.Char2ObjectMap.Entry<V>, java.util.Map.Entry<Character, V> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Char2ObjectOpenCustomHashMap.this.strategy.equals(Char2ObjectOpenCustomHashMap.this.key[this.index], (Character)e.getKey())
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.chars.Char2ObjectMap.Entry<V>> implements FastEntrySet<V> {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.chars.Char2ObjectMap.Entry<V>> consumer) {
			if (Char2ObjectOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Char2ObjectOpenCustomHashMap.this.key[Char2ObjectOpenCustomHashMap.this.n], Char2ObjectOpenCustomHashMap.this.value[Char2ObjectOpenCustomHashMap.this.n]
					)
				);
			}
