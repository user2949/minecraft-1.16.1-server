...
public class Char2DoubleOpenHashMap extends AbstractChar2DoubleMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		char[] key = this.key;
		double[] value = this.value;
		Char2DoubleOpenHashMap.MapIterator i = new Char2DoubleOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Char2DoubleOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.chars.Char2DoubleMap.Entry> {
	...
	private class FastEntryIterator extends Char2DoubleOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.chars.Char2DoubleMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.chars.Char2DoubleMap.Entry, java.util.Map.Entry<Character, Double> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Char2DoubleOpenHashMap.this.key[this.index] == (Character)e.getKey()
					&& Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits((Double)e.getValue());
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.chars.Char2DoubleMap.Entry> implements FastEntrySet {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.chars.Char2DoubleMap.Entry> consumer) {
			if (Char2DoubleOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Char2DoubleOpenHashMap.this.key[Char2DoubleOpenHashMap.this.n], Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.n])
				);
			}
