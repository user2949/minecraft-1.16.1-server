			...
			if (this.curr == -1) {
				...
				if (this.prev == -1) {
					...
					ShortLinkedOpenCustomHashSet.this.link[this.prev] = ShortLinkedOpenCustomHashSet.this.link[this.prev]
						^ (ShortLinkedOpenCustomHashSet.this.link[this.prev] ^ (long)this.next & 4294967295L) & 4294967295L;
				}
				...
				if (this.next == -1) {
					...
					ShortLinkedOpenCustomHashSet.this.link[this.next] = ShortLinkedOpenCustomHashSet.this.link[this.next]
						^ (ShortLinkedOpenCustomHashSet.this.link[this.next] ^ ((long)this.prev & 4294967295L) << 32) & -4294967296L;
				}
