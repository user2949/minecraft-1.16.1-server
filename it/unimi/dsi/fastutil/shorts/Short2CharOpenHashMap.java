...
public class Short2CharOpenHashMap extends AbstractShort2CharMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		short[] key = this.key;
		char[] value = this.value;
		Short2CharOpenHashMap.MapIterator i = new Short2CharOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Short2CharOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.shorts.Short2CharMap.Entry> {
	...
	private class FastEntryIterator extends Short2CharOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.shorts.Short2CharMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.shorts.Short2CharMap.Entry, java.util.Map.Entry<Short, Character> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Short2CharOpenHashMap.this.key[this.index] == (Short)e.getKey() && Short2CharOpenHashMap.this.value[this.index] == (Character)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.shorts.Short2CharMap.Entry> implements FastEntrySet {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.shorts.Short2CharMap.Entry> consumer) {
			if (Short2CharOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Short2CharOpenHashMap.this.key[Short2CharOpenHashMap.this.n], Short2CharOpenHashMap.this.value[Short2CharOpenHashMap.this.n])
				);
			}
