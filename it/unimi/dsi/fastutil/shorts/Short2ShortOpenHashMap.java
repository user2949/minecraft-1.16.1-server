...
public class Short2ShortOpenHashMap extends AbstractShort2ShortMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		short[] key = this.key;
		short[] value = this.value;
		Short2ShortOpenHashMap.MapIterator i = new Short2ShortOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Short2ShortOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.shorts.Short2ShortMap.Entry> {
	...
	private class FastEntryIterator extends Short2ShortOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.shorts.Short2ShortMap.Entry> {
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.shorts.Short2ShortMap.Entry> implements FastEntrySet {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.shorts.Short2ShortMap.Entry> consumer) {
			if (Short2ShortOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Short2ShortOpenHashMap.this.key[Short2ShortOpenHashMap.this.n], Short2ShortOpenHashMap.this.value[Short2ShortOpenHashMap.this.n])
				);
			}
