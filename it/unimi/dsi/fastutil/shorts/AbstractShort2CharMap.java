...
public abstract class AbstractShort2CharMap extends AbstractShort2CharFunction implements Short2CharMap, Serializable {
	...
	public boolean containsKey(short k) {
		ObjectIterator<Entry> i = this.short2CharEntrySet().iterator();
	...
	public void putAll(Map<? extends Short, ? extends Character> m) {
		if (m instanceof Short2CharMap) {
			ObjectIterator<Entry> i = Short2CharMaps.fastIterator((Short2CharMap)m);
			...
			int n = m.size();
			Iterator<? extends java.util.Map.Entry<? extends Short, ? extends Character>> i = m.entrySet().iterator();

			while (n-- != 0) {
				java.util.Map.Entry<? extends Short, ? extends Character> e = (java.util.Map.Entry<? extends Short, ? extends Character>)i.next();
	...
	public int hashCode() {
		int h = 0;
		int n = this.size();
		ObjectIterator<Entry> i = Short2CharMaps.fastIterator(this);
