...
public class Short2FloatOpenHashMap extends AbstractShort2FloatMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		short[] key = this.key;
		float[] value = this.value;
		Short2FloatOpenHashMap.MapIterator i = new Short2FloatOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Short2FloatOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.shorts.Short2FloatMap.Entry> {
	...
	private class FastEntryIterator extends Short2FloatOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.shorts.Short2FloatMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.shorts.Short2FloatMap.Entry, java.util.Map.Entry<Short, Float> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Short2FloatOpenHashMap.this.key[this.index] == (Short)e.getKey()
					&& Float.floatToIntBits(Short2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits((Float)e.getValue());
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.shorts.Short2FloatMap.Entry> implements FastEntrySet {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.shorts.Short2FloatMap.Entry> consumer) {
			if (Short2FloatOpenHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(Short2FloatOpenHashMap.this.key[Short2FloatOpenHashMap.this.n], Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n])
				);
			}
