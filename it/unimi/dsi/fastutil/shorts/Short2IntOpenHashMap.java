...
public class Short2IntOpenHashMap extends AbstractShort2IntMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		short[] key = this.key;
		int[] value = this.value;
		Short2IntOpenHashMap.MapIterator i = new Short2IntOpenHashMap.MapIterator();
	...
	private class EntryIterator extends Short2IntOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.shorts.Short2IntMap.Entry> {
	...
	private class FastEntryIterator extends Short2IntOpenHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.shorts.Short2IntMap.Entry> {
