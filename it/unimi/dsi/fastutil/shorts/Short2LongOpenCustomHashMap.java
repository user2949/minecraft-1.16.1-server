...
public class Short2LongOpenCustomHashMap extends AbstractShort2LongMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		short[] key = this.key;
		long[] value = this.value;
		Short2LongOpenCustomHashMap.MapIterator i = new Short2LongOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Short2LongOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.shorts.Short2LongMap.Entry> {
	...
	private class FastEntryIterator extends Short2LongOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.shorts.Short2LongMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.shorts.Short2LongMap.Entry, java.util.Map.Entry<Short, Long> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Short2LongOpenCustomHashMap.this.strategy.equals(Short2LongOpenCustomHashMap.this.key[this.index], (Short)e.getKey())
					&& Short2LongOpenCustomHashMap.this.value[this.index] == (Long)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.shorts.Short2LongMap.Entry> implements FastEntrySet {
				...
				if (e.getKey() == null || !(e.getKey() instanceof Short)) {
					...
					if (Short2LongOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
						...
						if ((curr = key[pos = HashCommon.mix(Short2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Short2LongOpenCustomHashMap.this.mask]) == 0) {
							return false;
						} else if (Short2LongOpenCustomHashMap.this.strategy.equals(k, curr)) {
				...
				if (e.getKey() != null && e.getKey() instanceof Short) {
					if (e.getValue() != null && e.getValue() instanceof Long) {
						...
						if (Short2LongOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
							...
							if ((curr = key[pos = HashCommon.mix(Short2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Short2LongOpenCustomHashMap.this.mask]) == 0) {
								return false;
							} else if (Short2LongOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.shorts.Short2LongMap.Entry> consumer) {
			if (Short2LongOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Short2LongOpenCustomHashMap.this.key[Short2LongOpenCustomHashMap.this.n], Short2LongOpenCustomHashMap.this.value[Short2LongOpenCustomHashMap.this.n]
					)
				);
			}
