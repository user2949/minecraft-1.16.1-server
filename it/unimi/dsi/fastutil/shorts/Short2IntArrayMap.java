...
public class Short2IntArrayMap extends AbstractShort2IntMap implements Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.shorts.Short2IntMap.Entry> implements FastEntrySet {
		private EntrySet() {
		}

		@Override
		public ObjectIterator<it.unimi.dsi.fastutil.shorts.Short2IntMap.Entry> iterator() {
			return new ObjectIterator<it.unimi.dsi.fastutil.shorts.Short2IntMap.Entry>() {
				int curr = -1;
				int next = 0;
				...
				public it.unimi.dsi.fastutil.shorts.Short2IntMap.Entry next() {
					if (!this.hasNext()) {
						...
						return new BasicEntry(Short2IntArrayMap.this.key[this.curr = this.next], Short2IntArrayMap.this.value[this.next++]);
					}
				}
