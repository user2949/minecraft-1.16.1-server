...
public class Short2BooleanOpenCustomHashMap extends AbstractShort2BooleanMap implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		short[] key = this.key;
		boolean[] value = this.value;
		Short2BooleanOpenCustomHashMap.MapIterator i = new Short2BooleanOpenCustomHashMap.MapIterator();
	...
	private class EntryIterator extends Short2BooleanOpenCustomHashMap.MapIterator implements ObjectIterator<it.unimi.dsi.fastutil.shorts.Short2BooleanMap.Entry> {
	...
	private class FastEntryIterator
		extends Short2BooleanOpenCustomHashMap.MapIterator
		implements ObjectIterator<it.unimi.dsi.fastutil.shorts.Short2BooleanMap.Entry> {
	...
	final class MapEntry implements it.unimi.dsi.fastutil.shorts.Short2BooleanMap.Entry, java.util.Map.Entry<Short, Boolean> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Short2BooleanOpenCustomHashMap.this.strategy.equals(Short2BooleanOpenCustomHashMap.this.key[this.index], (Short)e.getKey())
					&& Short2BooleanOpenCustomHashMap.this.value[this.index] == (Boolean)e.getValue();
			}
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.shorts.Short2BooleanMap.Entry> implements FastEntrySet {
				...
				if (e.getKey() == null || !(e.getKey() instanceof Short)) {
					...
					if (Short2BooleanOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
						...
						if ((curr = key[pos = HashCommon.mix(Short2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Short2BooleanOpenCustomHashMap.this.mask]) == 0) {
							return false;
						} else if (Short2BooleanOpenCustomHashMap.this.strategy.equals(k, curr)) {
				...
				if (e.getKey() != null && e.getKey() instanceof Short) {
					if (e.getValue() != null && e.getValue() instanceof Boolean) {
						...
						if (Short2BooleanOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
							...
							if ((curr = key[pos = HashCommon.mix(Short2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Short2BooleanOpenCustomHashMap.this.mask]) == 0) {
								return false;
							} else if (Short2BooleanOpenCustomHashMap.this.strategy.equals(curr, k)) {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.shorts.Short2BooleanMap.Entry> consumer) {
			if (Short2BooleanOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Short2BooleanOpenCustomHashMap.this.key[Short2BooleanOpenCustomHashMap.this.n],
						Short2BooleanOpenCustomHashMap.this.value[Short2BooleanOpenCustomHashMap.this.n]
					)
				);
			}
