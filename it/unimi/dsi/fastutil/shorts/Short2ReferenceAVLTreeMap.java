...
public class Short2ReferenceAVLTreeMap<V> extends AbstractShort2ReferenceSortedMap<V> implements Serializable, Cloneable {
	...
	private Short2ReferenceAVLTreeMap.Entry<V> parent(Short2ReferenceAVLTreeMap.Entry<V> e) {
		if (e == this.tree) {
			...
			Short2ReferenceAVLTreeMap.Entry<V> x;
		...
		if (this.tree == null) {
			...
			while (q != null) {
				...
				if (!dir) {
					...
					if (y.balance() == -2) {
						Short2ReferenceAVLTreeMap.Entry<V> xx = y.left;
						...
						if (xx.balance() == 1) {
							...
							Short2ReferenceAVLTreeMap.Entry<V> wx = xx.right;
							xx.right = wx.left;
							wx.left = xx;
							y.left = wx.right;
							wx.right = y;
	...
	public ObjectSortedSet<it.unimi.dsi.fastutil.shorts.Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
		if (this.entries == null) {
			this.entries = new AbstractObjectSortedSet<it.unimi.dsi.fastutil.shorts.Short2ReferenceMap.Entry<V>>() {
				final Comparator<? super it.unimi.dsi.fastutil.shorts.Short2ReferenceMap.Entry<V>> comparator = (x, y) -> Short2ReferenceAVLTreeMap.this.actualComparator
	...
	private final class Submap extends AbstractShort2ReferenceSortedMap<V> implements Serializable {
		...
		public V get(short k) {
			...
			return this.in(k) && (e = Short2ReferenceAVLTreeMap.this.findKey(k)) != null ? e.value : this.defRetValue;
		}
		...
		public Short2ReferenceSortedMap<V> headMap(short to) {
			if (this.top) {
				...
				return Short2ReferenceAVLTreeMap.this.compare(to, this.to) < 0 ? Short2ReferenceAVLTreeMap.this.new Submap(this.from, this.bottom, to, false) : this;
			}
		}
		...
		public Short2ReferenceSortedMap<V> tailMap(short from) {
			if (this.bottom) {
				...
				return Short2ReferenceAVLTreeMap.this.compare(from, this.from) > 0 ? Short2ReferenceAVLTreeMap.this.new Submap(from, false, this.to, this.top) : this;
			}
		}
