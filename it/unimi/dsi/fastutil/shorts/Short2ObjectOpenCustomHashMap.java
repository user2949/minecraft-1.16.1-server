...
public class Short2ObjectOpenCustomHashMap<V> extends AbstractShort2ObjectMap<V> implements Serializable, Cloneable, Hash {
	...
	private void writeObject(ObjectOutputStream s) throws IOException {
		short[] key = this.key;
		V[] value = this.value;
		Short2ObjectOpenCustomHashMap<V>.MapIterator i = new Short2ObjectOpenCustomHashMap.MapIterator();
	...
	final class MapEntry implements it.unimi.dsi.fastutil.shorts.Short2ObjectMap.Entry<V>, java.util.Map.Entry<Short, V> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof java.util.Map.Entry)) {
				...
				return Short2ObjectOpenCustomHashMap.this.strategy.equals(Short2ObjectOpenCustomHashMap.this.key[this.index], (Short)e.getKey())
	...
	private final class MapEntrySet extends AbstractObjectSet<it.unimi.dsi.fastutil.shorts.Short2ObjectMap.Entry<V>> implements FastEntrySet<V> {
		...
		public void forEach(Consumer<? super it.unimi.dsi.fastutil.shorts.Short2ObjectMap.Entry<V>> consumer) {
			if (Short2ObjectOpenCustomHashMap.this.containsNullKey) {
				consumer.accept(
					new BasicEntry(
						Short2ObjectOpenCustomHashMap.this.key[Short2ObjectOpenCustomHashMap.this.n],
						Short2ObjectOpenCustomHashMap.this.value[Short2ObjectOpenCustomHashMap.this.n]
					)
				);
			}
			...
			while (pos-- != 0) {
				if (Short2ObjectOpenCustomHashMap.this.key[pos] != 0) {
					consumer.accept(new BasicEntry(Short2ObjectOpenCustomHashMap.this.key[pos], Short2ObjectOpenCustomHashMap.this.value[pos]));
				}
			}
		}
