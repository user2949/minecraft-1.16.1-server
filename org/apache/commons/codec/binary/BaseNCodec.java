...
public abstract class BaseNCodec implements BinaryEncoder, BinaryDecoder {
	...
	abstract void encode(byte[] arr, int integer2, int integer3, BaseNCodec.Context context);

	abstract void decode(byte[] arr, int integer2, int integer3, BaseNCodec.Context context);

	protected abstract boolean isInAlphabet(byte byte1);
