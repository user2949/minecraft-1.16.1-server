...
public class FastDateParser implements DateParser, Serializable {
	...
	private void init(Calendar definingCalendar) {
		...
		FastDateParser.StrategyParser fm = new FastDateParser.StrategyParser(this.pattern, definingCalendar);
	...
	public boolean parse(String source, ParsePosition pos, Calendar calendar) {
		...
		while (lt.hasNext()) {
			FastDateParser.StrategyAndWidth pattern = (FastDateParser.StrategyAndWidth)lt.next();
