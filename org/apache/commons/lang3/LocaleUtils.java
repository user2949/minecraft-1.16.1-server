...
public class LocaleUtils {
	...
	public static List<Locale> languagesByCountry(String countryCode) {
		if (countryCode == null) {
			...
			List<Locale> langs = (List<Locale>)cLanguagesByCountry.get(countryCode);
			if (langs == null) {
				...
				langs = (List<Locale>)cLanguagesByCountry.get(countryCode);
			}
	...
	public static List<Locale> countriesByLanguage(String languageCode) {
		if (languageCode == null) {
			...
			List<Locale> countries = (List<Locale>)cCountriesByLanguage.get(languageCode);
			if (countries == null) {
				List<Locale> var5 = new ArrayList();
				List<Locale> locales = availableLocaleList();
				...
				countries = (List<Locale>)cCountriesByLanguage.get(languageCode);
			}
