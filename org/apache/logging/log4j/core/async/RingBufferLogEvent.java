...
public class RingBufferLogEvent implements LogEvent, ReusableMessage, CharSequence {
	...
	public Message memento() {
		if (this.message != null) {
			...
			Object[] params = this.parameters == null ? new Object[0] : Arrays.copyOf(this.parameters, this.parameterCount);
	...
	public void initializeBuilder(Builder builder) {
		builder.setContextData(this.contextData)
			...
			.setMessage(this.getNonNullImmutableMessage())
			...
			.setTimeMillis(this.currentTimeMillis);
	}
