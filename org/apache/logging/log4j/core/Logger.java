...
public class Logger extends AbstractLogger implements Supplier<LoggerConfig> {
	...
	protected class PrivateConfig {
		...
		boolean filter(Level level, Marker marker, String msg) {
			...
			if (filter != null) {
				Result r = filter.filter(this.logger, level, marker, msg);
				if (r != Result.NEUTRAL) {
		...
		boolean filter(Level level, Marker marker, String msg, Object... p1) {
			Filter filter = this.config.getFilter();
			if (filter != null) {
				Result r = filter.filter(this.logger, level, marker, msg, p1);
				if (r != Result.NEUTRAL) {
					return r == Result.ACCEPT;
				}
			}
		...
		boolean filter(Level level, Marker marker, String msg, Object p0) {
			Filter filter = this.config.getFilter();
			if (filter != null) {
				Result r = filter.filter(this.logger, level, marker, msg, p0);
				if (r != Result.NEUTRAL) {
					return r == Result.ACCEPT;
				}
			}
		...
		boolean filter(Level level, Marker marker, String msg, Object p0, Object p1) {
			Filter filter = this.config.getFilter();
			if (filter != null) {
				Result r = filter.filter(this.logger, level, marker, msg, p0, p1);
				if (r != Result.NEUTRAL) {
					return r == Result.ACCEPT;
				}
			}
		...
		boolean filter(Level level, Marker marker, String msg, Object p0, Object p1, Object p2) {
			Filter filter = this.config.getFilter();
			if (filter != null) {
				Result r = filter.filter(this.logger, level, marker, msg, p0, p1, p2);
				if (r != Result.NEUTRAL) {
					return r == Result.ACCEPT;
				}
			}
		...
		boolean filter(Level level, Marker marker, String msg, Object p0, Object p1, Object p2, Object p3) {
			Filter filter = this.config.getFilter();
			if (filter != null) {
				Result r = filter.filter(this.logger, level, marker, msg, p0, p1, p2, p3);
				if (r != Result.NEUTRAL) {
					return r == Result.ACCEPT;
				}
			}
		...
		boolean filter(Level level, Marker marker, String msg, Object p0, Object p1, Object p2, Object p3, Object p4) {
			Filter filter = this.config.getFilter();
			if (filter != null) {
				Result r = filter.filter(this.logger, level, marker, msg, p0, p1, p2, p3, p4);
				if (r != Result.NEUTRAL) {
					return r == Result.ACCEPT;
				}
			}
		...
		boolean filter(Level level, Marker marker, String msg, Object p0, Object p1, Object p2, Object p3, Object p4, Object p5) {
			Filter filter = this.config.getFilter();
			if (filter != null) {
				Result r = filter.filter(this.logger, level, marker, msg, p0, p1, p2, p3, p4, p5);
				if (r != Result.NEUTRAL) {
					return r == Result.ACCEPT;
				}
			}
		...
		boolean filter(Level level, Marker marker, String msg, Object p0, Object p1, Object p2, Object p3, Object p4, Object p5, Object p6) {
			Filter filter = this.config.getFilter();
			if (filter != null) {
				Result r = filter.filter(this.logger, level, marker, msg, p0, p1, p2, p3, p4, p5, p6);
				if (r != Result.NEUTRAL) {
					return r == Result.ACCEPT;
				}
			}
		...
		boolean filter(Level level, Marker marker, String msg, Object p0, Object p1, Object p2, Object p3, Object p4, Object p5, Object p6, Object p7) {
			Filter filter = this.config.getFilter();
			if (filter != null) {
				Result r = filter.filter(this.logger, level, marker, msg, p0, p1, p2, p3, p4, p5, p6, p7);
				if (r != Result.NEUTRAL) {
					return r == Result.ACCEPT;
				}
			}
		...
		boolean filter(Level level, Marker marker, String msg, Object p0, Object p1, Object p2, Object p3, Object p4, Object p5, Object p6, Object p7, Object p8) {
			Filter filter = this.config.getFilter();
			if (filter != null) {
				Result r = filter.filter(this.logger, level, marker, msg, p0, p1, p2, p3, p4, p5, p6, p7, p8);
				if (r != Result.NEUTRAL) {
					return r == Result.ACCEPT;
				}
			}
		...
		boolean filter(
			Level level, Marker marker, String msg, Object p0, Object p1, Object p2, Object p3, Object p4, Object p5, Object p6, Object p7, Object p8, Object p9
		) {
			Filter filter = this.config.getFilter();
			if (filter != null) {
				Result r = filter.filter(this.logger, level, marker, msg, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9);
				if (r != Result.NEUTRAL) {
					return r == Result.ACCEPT;
				}
			}
