...
public class ThrowableAttributeConverter implements AttributeConverter<Throwable, String> {
	...
	private Throwable getThrowable(String throwableClassName, String message, Throwable cause, StackTraceElement[] stackTrace) {
		try {
			Class<Throwable> throwableClass = (Class<Throwable>)LoaderUtil.loadClass(throwableClassName);
	...
	private Throwable getThrowable(Class<Throwable> throwableClass, String message, Throwable cause) {
		try {
			Constructor<Throwable>[] constructors = throwableClass.getConstructors();
