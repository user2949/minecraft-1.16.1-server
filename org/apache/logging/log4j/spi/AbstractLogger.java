...
public abstract class AbstractLogger implements ExtendedLogger, Serializable {
	...
	private static Class<? extends MessageFactory> createClassForProperty(
		String property, Class<ReusableMessageFactory> reusableParameterizedMessageFactoryClass, Class<ParameterizedMessageFactory> parameterizedMessageFactoryClass
	) {
		try {
	...
	private static MessageFactory2 createDefaultMessageFactory() {
		try {
			MessageFactory result = (MessageFactory)DEFAULT_MESSAGE_FACTORY_CLASS.newInstance();
	...
	protected EntryMessage enter(String fqcn, MessageSupplier msgSupplier) {
		...
		if (this.isEnabled(Level.TRACE, ENTRY_MARKER, (Object)null, null)) {
			this.logMessageSafely(fqcn, Level.TRACE, ENTRY_MARKER, message = this.flowMessageFactory.newEntryMessage(msgSupplier.get()), null);
		}
	...
	@Override
	public void logIfEnabled(
		String fqcn, Level level, Marker marker, String message, Object p0, Object p1, Object p2, Object p3, Object p4, Object p5, Object p6, Object p7, Object p8
	) {
