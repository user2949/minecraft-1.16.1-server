...
public final class ObjectCleaner {
		...
		public void run() {
			...
			do {
				while (!ObjectCleaner.LIVE_SET.isEmpty()) {
					...
					try {
						reference = (ObjectCleaner.AutomaticCleanerReference)ObjectCleaner.REFERENCE_QUEUE.remove((long)ObjectCleaner.REFERENCE_QUEUE_POLL_TIMEOUT_MS);
	...
	public static void register(Object object, Runnable cleanupTask) {
		ObjectCleaner.AutomaticCleanerReference reference = new ObjectCleaner.AutomaticCleanerReference(object, ObjectUtil.checkNotNull(cleanupTask, "cleanupTask"));
