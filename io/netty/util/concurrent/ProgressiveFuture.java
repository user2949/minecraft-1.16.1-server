...
public interface ProgressiveFuture<V> extends Future<V> {
	...
	ProgressiveFuture<V> addListeners(GenericFutureListener<? extends Future<? super V>>... arr);

	ProgressiveFuture<V> removeListener(GenericFutureListener<? extends Future<? super V>> genericFutureListener);

	ProgressiveFuture<V> removeListeners(GenericFutureListener<? extends Future<? super V>>... arr);
