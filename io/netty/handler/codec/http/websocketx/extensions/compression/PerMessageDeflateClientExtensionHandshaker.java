	...
	public WebSocketClientExtension handshakeExtension(WebSocketExtensionData extensionData) {
		if (!"permessage-deflate".equals(extensionData.name())) {
			...
			while (succeed && parametersIterator.hasNext()) {
				Entry<String, String> parameter = (Entry<String, String>)parametersIterator.next();
			...
			return succeed
				? new PerMessageDeflateClientExtensionHandshaker.PermessageDeflateExtension(serverNoContext, serverWindowSize, clientNoContext, clientWindowSize)
				: null;
		}
	}
