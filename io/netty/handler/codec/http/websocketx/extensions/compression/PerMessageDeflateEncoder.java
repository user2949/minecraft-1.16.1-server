...
class PerMessageDeflateEncoder extends DeflateEncoder {
	...
	public boolean acceptOutboundMessage(Object msg) throws Exception {
		return (msg instanceof TextWebSocketFrame || msg instanceof BinaryWebSocketFrame) && (((WebSocketFrame)msg).rsv() & 4) == 0
			|| msg instanceof ContinuationWebSocketFrame && this.compressing;
	}
