...
public abstract class HttpObjectEncoder<H extends HttpMessage> extends MessageToMessageEncoder<Object> {
	...
	protected void encodeHeaders(HttpHeaders headers, ByteBuf buf) {
		...
		while (iter.hasNext()) {
			Entry<CharSequence, CharSequence> header = (Entry<CharSequence, CharSequence>)iter.next();
	...
	protected abstract void encodeInitialLine(ByteBuf byteBuf, H httpMessage) throws Exception;
}
