...
public abstract class HttpHeaders implements Iterable<Entry<String, String>> {
	...
	public abstract int getInt(CharSequence charSequence, int integer);

	public abstract Short getShort(CharSequence charSequence);

	public abstract short getShort(CharSequence charSequence, short short2);

	public abstract Long getTimeMillis(CharSequence charSequence);

	public abstract long getTimeMillis(CharSequence charSequence, long long2);

	public abstract List<String> getAll(String string);
	...
	public abstract HttpHeaders add(String string, Object object);

	public HttpHeaders add(CharSequence name, Object value) {
		return this.add(name.toString(), value);
	}

	public abstract HttpHeaders add(String string, Iterable<?> iterable);
	...
	public abstract HttpHeaders addInt(CharSequence charSequence, int integer);

	public abstract HttpHeaders addShort(CharSequence charSequence, short short2);

	public abstract HttpHeaders set(String string, Object object);

	public HttpHeaders set(CharSequence name, Object value) {
		return this.set(name.toString(), value);
	}

	public abstract HttpHeaders set(String string, Iterable<?> iterable);
	...
	public abstract HttpHeaders setInt(CharSequence charSequence, int integer);

	public abstract HttpHeaders setShort(CharSequence charSequence, short short2);

	public abstract HttpHeaders remove(String string);
