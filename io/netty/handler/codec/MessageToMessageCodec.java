...
public abstract class MessageToMessageCodec<INBOUND_IN, OUTBOUND_IN> extends ChannelDuplexHandler {
	...
	protected abstract void encode(ChannelHandlerContext channelHandlerContext, OUTBOUND_IN object, List<Object> list) throws Exception;

	protected abstract void decode(ChannelHandlerContext channelHandlerContext, INBOUND_IN object, List<Object> list) throws Exception;
}
