...
public final class JdkSslClientContext extends JdkSslContext {
	...
	JdkSslClientContext(
		...
		super(
			newSSLContext(provider, toX509CertificatesInternal(trustCertCollectionFile), trustManagerFactory, null, null, null, null, sessionCacheSize, sessionTimeout),
			true,
			ciphers,
			cipherFilter,
			apn,
	...
	private static SSLContext newSSLContext(
		...
		try {
			...
			ctx.init(
				keyManagerFactory == null ? null : keyManagerFactory.getKeyManagers(), trustManagerFactory == null ? null : trustManagerFactory.getTrustManagers(), null
			);
