...
public final class ReferenceCountedOpenSslClientContext extends ReferenceCountedOpenSslContext {
	...
	ReferenceCountedOpenSslClientContext(
		...
		super(ciphers, cipherFilter, apn, sessionCacheSize, sessionTimeout, 0, keyCertChain, ClientAuth.NONE, protocols, false, enableOcsp, true);
	...
	static OpenSslSessionContext newSessionContext(
		...
		if ((key != null || keyCertChain == null) && (key == null || keyCertChain != null)) {
			try {
				if (!OpenSsl.useKeyManagerFactory()) {
					...
					if (keyManagerFactory != null) {
						...
						OpenSslKeyMaterialManager materialManager = (OpenSslKeyMaterialManager)(useExtendedKeyManager(keyManager)
						...
						SSLContext.setCertRequestedCallback(ctx, new ReferenceCountedOpenSslClientContext.OpenSslCertificateRequestedCallback(engineMap, materialManager));
					}
				}
			...
			return new ReferenceCountedOpenSslClientContext.OpenSslClientSessionContext(thiz);
		} else {
