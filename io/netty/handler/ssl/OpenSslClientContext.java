...
public final class OpenSslClientContext extends OpenSslContext {
	...
	OpenSslClientContext(
		...
		super(ciphers, cipherFilter, apn, sessionCacheSize, sessionTimeout, 0, keyCertChain, ClientAuth.NONE, protocols, false, enableOcsp);
		boolean success = false;

		try {
			this.sessionContext = ReferenceCountedOpenSslClientContext.newSessionContext(
