...
final class HeapByteBufUtil {
	...
	static long getLong(byte[] memory, int index) {
		return ((long)memory[index] & 255L) << 56
			| ((long)memory[index + 1] & 255L) << 48
			| ((long)memory[index + 2] & 255L) << 40
			| ((long)memory[index + 3] & 255L) << 32
			| ((long)memory[index + 4] & 255L) << 24
			| ((long)memory[index + 5] & 255L) << 16
			| ((long)memory[index + 6] & 255L) << 8
			| (long)memory[index + 7] & 255L;
	}

	static long getLongLE(byte[] memory, int index) {
		return (long)memory[index] & 255L
			| ((long)memory[index + 1] & 255L) << 8
			| ((long)memory[index + 2] & 255L) << 16
			| ((long)memory[index + 3] & 255L) << 24
			| ((long)memory[index + 4] & 255L) << 32
			| ((long)memory[index + 5] & 255L) << 40
			| ((long)memory[index + 6] & 255L) << 48
			| ((long)memory[index + 7] & 255L) << 56;
	}
