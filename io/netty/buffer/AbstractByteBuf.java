...
public abstract class AbstractByteBuf extends ByteBuf {
	...
	public ByteBuf asReadOnly() {
		return (ByteBuf)(this.isReadOnly() ? this : Unpooled.unmodifiableBuffer(this));
	}
	...
	public ByteBuf writerIndex(int writerIndex) {
		if (writerIndex >= this.readerIndex && writerIndex <= this.capacity()) {
			...
			throw new IndexOutOfBoundsException(
				String.format("writerIndex: %d (expected: readerIndex(%d) <= writerIndex <= capacity(%d))", writerIndex, this.readerIndex, this.capacity())
			);
		}
	}
	...
	public ByteBuf setIndex(int readerIndex, int writerIndex) {
		if (readerIndex >= 0 && readerIndex <= writerIndex && writerIndex <= this.capacity()) {
			...
			throw new IndexOutOfBoundsException(
				String.format("readerIndex: %d, writerIndex: %d (expected: 0 <= readerIndex <= writerIndex <= capacity(%d))", readerIndex, writerIndex, this.capacity())
			);
		}
	}
	...
	final void ensureWritable0(int minWritableBytes) {
		...
		if (minWritableBytes > this.writableBytes()) {
			if (minWritableBytes > this.maxCapacity - this.writerIndex) {
				throw new IndexOutOfBoundsException(
					String.format("writerIndex(%d) + minWritableBytes(%d) exceeds maxCapacity(%d): %s", this.writerIndex, minWritableBytes, this.maxCapacity, this)
				);
			} else {
	...
	protected abstract byte _getByte(int integer);
	...
	protected abstract short _getShort(int integer);
	...
	protected abstract short _getShortLE(int integer);
	...
	protected abstract int _getUnsignedMedium(int integer);
	...
	protected abstract int _getUnsignedMediumLE(int integer);
	...
	protected abstract int _getInt(int integer);
	...
	protected abstract int _getIntLE(int integer);
	...
	protected abstract long _getLong(int integer);
	...
	protected abstract long _getLongLE(int integer);
	...
	protected abstract void _setByte(int integer1, int integer2);
	...
	protected abstract void _setShort(int integer1, int integer2);
	...
	protected abstract void _setShortLE(int integer1, int integer2);
	...
	protected abstract void _setMedium(int integer1, int integer2);
	...
	protected abstract void _setMediumLE(int integer1, int integer2);
	...
	protected abstract void _setInt(int integer1, int integer2);
	...
	protected abstract void _setIntLE(int integer1, int integer2);
	...
	protected abstract void _setLong(int integer, long long2);
	...
	protected abstract void _setLongLE(int integer, long long2);
