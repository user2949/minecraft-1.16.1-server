...
final class UnsafeByteBufUtil {
	...
	static int getUnsignedMedium(long address) {
		return UNALIGNED
			? (PlatformDependent.getByte(address) & 0xFF) << 16
				| (PlatformDependent.BIG_ENDIAN_NATIVE_ORDER ? PlatformDependent.getShort(address + 1L) : Short.reverseBytes(PlatformDependent.getShort(address + 1L)))
					& 65535
			: (PlatformDependent.getByte(address) & 0xFF) << 16 | (PlatformDependent.getByte(address + 1L) & 0xFF) << 8 | PlatformDependent.getByte(address + 2L) & 0xFF;
	}
	...
	static int getUnsignedMediumLE(long address) {
		return UNALIGNED
			? PlatformDependent.getByte(address) & 0xFF
				| (
						(PlatformDependent.BIG_ENDIAN_NATIVE_ORDER ? Short.reverseBytes(PlatformDependent.getShort(address + 1L)) : PlatformDependent.getShort(address + 1L))
							& 65535
					)
					<< 8
			: PlatformDependent.getByte(address) & 0xFF | (PlatformDependent.getByte(address + 1L) & 0xFF) << 8 | (PlatformDependent.getByte(address + 2L) & 0xFF) << 16;
	}
	...
	static long getLong(long address) {
		if (UNALIGNED) {
			...
			return (long)PlatformDependent.getByte(address) << 56
				| ((long)PlatformDependent.getByte(address + 1L) & 255L) << 48
				| ((long)PlatformDependent.getByte(address + 2L) & 255L) << 40
				| ((long)PlatformDependent.getByte(address + 3L) & 255L) << 32
				| ((long)PlatformDependent.getByte(address + 4L) & 255L) << 24
				| ((long)PlatformDependent.getByte(address + 5L) & 255L) << 16
				| ((long)PlatformDependent.getByte(address + 6L) & 255L) << 8
				| (long)PlatformDependent.getByte(address + 7L) & 255L;
		}
	}
	...
	static long getLongLE(long address) {
		if (UNALIGNED) {
			...
			return (long)PlatformDependent.getByte(address) & 255L
				| ((long)PlatformDependent.getByte(address + 1L) & 255L) << 8
				| ((long)PlatformDependent.getByte(address + 2L) & 255L) << 16
				| ((long)PlatformDependent.getByte(address + 3L) & 255L) << 24
				| ((long)PlatformDependent.getByte(address + 4L) & 255L) << 32
				| ((long)PlatformDependent.getByte(address + 5L) & 255L) << 40
				| ((long)PlatformDependent.getByte(address + 6L) & 255L) << 48
	...
	static long getLong(byte[] array, int index) {
		if (UNALIGNED) {
			...
			return (long)PlatformDependent.getByte(array, index) << 56
				| ((long)PlatformDependent.getByte(array, index + 1) & 255L) << 48
				| ((long)PlatformDependent.getByte(array, index + 2) & 255L) << 40
				| ((long)PlatformDependent.getByte(array, index + 3) & 255L) << 32
				| ((long)PlatformDependent.getByte(array, index + 4) & 255L) << 24
				| ((long)PlatformDependent.getByte(array, index + 5) & 255L) << 16
				| ((long)PlatformDependent.getByte(array, index + 6) & 255L) << 8
				| (long)PlatformDependent.getByte(array, index + 7) & 255L;
		}
	}
	...
	static long getLongLE(byte[] array, int index) {
		if (UNALIGNED) {
			...
			return (long)PlatformDependent.getByte(array, index) & 255L
				| ((long)PlatformDependent.getByte(array, index + 1) & 255L) << 8
				| ((long)PlatformDependent.getByte(array, index + 2) & 255L) << 16
				| ((long)PlatformDependent.getByte(array, index + 3) & 255L) << 24
				| ((long)PlatformDependent.getByte(array, index + 4) & 255L) << 32
				| ((long)PlatformDependent.getByte(array, index + 5) & 255L) << 40
				| ((long)PlatformDependent.getByte(array, index + 6) & 255L) << 48
	...
	static UnpooledUnsafeDirectByteBuf newUnsafeDirectByteBuf(ByteBufAllocator alloc, int initialCapacity, int maxCapacity) {
		return (UnpooledUnsafeDirectByteBuf)(PlatformDependent.useDirectBufferNoCleaner()
			? new UnpooledUnsafeNoCleanerDirectByteBuf(alloc, initialCapacity, maxCapacity)
			: new UnpooledUnsafeDirectByteBuf(alloc, initialCapacity, maxCapacity));
	}
