...
abstract class AbstractUnsafeSwappedByteBuf extends SwappedByteBuf {
	...
	protected abstract short _getShort(AbstractByteBuf abstractByteBuf, int integer);

	protected abstract int _getInt(AbstractByteBuf abstractByteBuf, int integer);

	protected abstract long _getLong(AbstractByteBuf abstractByteBuf, int integer);

	protected abstract void _setShort(AbstractByteBuf abstractByteBuf, int integer, short short3);

	protected abstract void _setInt(AbstractByteBuf abstractByteBuf, int integer2, int integer3);

	protected abstract void _setLong(AbstractByteBuf abstractByteBuf, int integer, long long3);
}
