...
final class NativeLongArray {
	...
	NativeLongArray(int capacity) {
		if (capacity < 1) {
			...
			this.memoryAddress = PlatformDependent.allocateMemory((long)(capacity * Limits.SIZEOF_JLONG));
	...
	private void realloc() {
		...
		long newMemoryAddress = PlatformDependent.reallocateMemory(this.memoryAddress, (long)(newLength * Limits.SIZEOF_JLONG));
