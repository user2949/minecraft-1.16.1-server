...
public final class Iterators {
	...
	public static boolean contains(Iterator<?> iterator, @Nullable Object element) {
		return any((Iterator<Object>)iterator, Predicates.equalTo(element));
	}
	...
	public static <T> boolean removeIf(Iterator<T> removeFrom, Predicate<? super T> predicate) {
		...
		while (removeFrom.hasNext()) {
			if (predicate.apply((T)removeFrom.next())) {
				removeFrom.remove();
				modified = true;
			}
		}
	...
	public static <T> T[] toArray(Iterator<? extends T> iterator, Class<T> type) {
		List<T> list = Lists.<T>newArrayList(iterator);
	...
	public static int frequency(Iterator<?> iterator, @Nullable Object element) {
		return size(filter((Iterator<Object>)iterator, Predicates.equalTo(element)));
	}
	...
	public static <T> Optional<T> tryFind(Iterator<T> iterator, Predicate<? super T> predicate) {
		...
		return filteredIterator.hasNext() ? Optional.of((T)filteredIterator.next()) : Optional.absent();
	}
	...
	private static class MergingIterator<T> extends UnmodifiableIterator<T> {
		...
		public T next() {
			PeekingIterator<T> nextIter = (PeekingIterator<T>)this.queue.remove();
