	...
	public void loadFromStorage(Map<String, Object> credentials) {
		...
		if (credentials.containsKey("displayName") && credentials.containsKey("uuid")) {
			...
			if (credentials.containsKey("profileProperties")) {
				try {
					for (Map<String, String> propertyMapx : (List)credentials.get("profileProperties")) {
						String name = (String)propertyMapx.get("name");
						String value = (String)propertyMapx.get("value");
						String signature = (String)propertyMapx.get("signature");
						if (signature == null) {
