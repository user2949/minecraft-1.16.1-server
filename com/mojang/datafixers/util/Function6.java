...
public interface Function6<T1, T2, T3, T4, T5, T6, R> {
	R apply(T1 object1, T2 object2, T3 object3, T4 object4, T5 object5, T6 object6);

	default Function<T1, Function5<T2, T3, T4, T5, T6, R>> curry() {
		return t1 -> (t2, t3, t4, t5, t6) -> this.apply((T1)t1, (T2)t2, (T3)t3, (T4)t4, (T5)t5, (T6)t6);
	}
	...
	default Function4<T1, T2, T3, T4, BiFunction<T5, T6, R>> curry4() {
		return (t1, t2, t3, t4) -> (t5, t6) -> this.apply(t1, t2, t3, t4, (T5)t5, (T6)t6);
	}

	default Function5<T1, T2, T3, T4, T5, Function<T6, R>> curry5() {
		return (t1, t2, t3, t4, t5) -> t6 -> this.apply(t1, t2, t3, t4, t5, (T6)t6);
	}
}
