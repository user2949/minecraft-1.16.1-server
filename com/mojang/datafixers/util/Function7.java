...
public interface Function7<T1, T2, T3, T4, T5, T6, T7, R> {
	R apply(T1 object1, T2 object2, T3 object3, T4 object4, T5 object5, T6 object6, T7 object7);

	default Function<T1, Function6<T2, T3, T4, T5, T6, T7, R>> curry() {
		return t1 -> (t2, t3, t4, t5, t6, t7) -> this.apply((T1)t1, (T2)t2, (T3)t3, (T4)t4, (T5)t5, (T6)t6, (T7)t7);
	}
	...
	default Function5<T1, T2, T3, T4, T5, BiFunction<T6, T7, R>> curry5() {
		return (t1, t2, t3, t4, t5) -> (t6, t7) -> this.apply(t1, t2, t3, t4, t5, (T6)t6, (T7)t7);
	}

	default Function6<T1, T2, T3, T4, T5, T6, Function<T7, R>> curry6() {
		return (t1, t2, t3, t4, t5, t6) -> t7 -> this.apply(t1, t2, t3, t4, t5, t6, (T7)t7);
	}
}
